...
Please see [CONTRIBUTING](https://github.com/ziadoz/awesome-php/blob/master/CONTRIBUTING.md) ⭐ 32,711 | 🐛 93 | 📅 2026-07-13, [CODE-OF-CONDUCT](https://github.com/ziadoz/awesome-php/blob/master/CODE-OF-CONDUCT.md) ⭐ 32,711 | 🐛 93 | 📅 2026-07-13 and [COLLABORATING](https://github.com/ziadoz/awesome-php/blob/master/COLLABORATING.md) ⭐ 32,711 | 🐛 93 | 📅 2026-07-13 for details.
...
* [Pie](https://github.com/php/pie) ⭐ 2,026 | 🐛 18 | 🌐 PHP | 📅 2026-09-18 - The official PHP installer for extensions.
...
* [Satis](https://github.com/composer/satis) ⭐ 3,305 | 🐛 100 | 🌐 PHP | 📅 2026-09-24 - A static Composer repository generator.
...
* [Composer Normalize](https://github.com/ergebnis/composer-normalize) ⭐ 1,126 | 🐛 8 | 🌐 PHP | 📅 2026-09-24 - A plugin for normalizing `composer.json` files.
...
* [Yii2](https://github.com/yiisoft/yii2/) ⭐ 14,291 | 🐛 332 | 🌐 PHP | 📅 2026-09-25 - A fast, secure, and efficient web framework.
* [Tempest](https://github.com/tempestphp/tempest-framework) ⭐ 2,270 | 🐛 34 | 🌐 PHP | 📅 2026-09-14 - A framework that gets out of your way.
...
* [WordPress](https://github.com/WordPress/WordPress) ⭐ 21,434 | 🐛 3 | 🌐 PHP | 📅 2026-09-26 - A blogging platform and CMS.
* [Grav](https://github.com/getgrav/grav) ⭐ 15,675 | 🐛 420 | 🌐 PHP | 📅 2026-09-25 - A modern flat-file CMS.
* [Magento](https://github.com/magento/magento2) ⭐ 12,200 | 🐛 2,235 | 🌐 PHP | 📅 2026-09-25 - A widely used open-source e-commerce platform.
* [CraftCMS](https://github.com/craftcms/cms) ⭐ 3,608 | 🐛 521 | 🌐 PHP | 📅 2026-09-25 - A flexible, user-friendly CMS for creating custom digital experiences on the web and beyond.
* [OpenMage](https://github.com/OpenMage/magento-lts) ⭐ 933 | 🐛 283 | 🌐 PHP | 📅 2026-09-25 - Fork of EoL Magento 1 e-commerce platform.
...
* [Fast Route](https://github.com/nikic/FastRoute) ⭐ 5,266 | 🐛 28 | 🌐 PHP | 📅 2026-07-09 - A fast routing library.
...
* [Requests](https://github.com/WordPress/Requests) ⭐ 3,575 | 🐛 128 | 🌐 PHP | 📅 2026-09-25 - A simple HTTP library.
...
* [Symfony HTTP Client](https://github.com/symfony/http-client) ⭐ 2,030 | 🐛 0 | 🌐 PHP | 📅 2026-09-24 - A component to fetch HTTP resources synchronously or asynchronously.
...
* [Laminas Diactoros](https://github.com/laminas/laminas-diactoros) ⭐ 560 | 🐛 33 | 🌐 PHP | 📅 2026-09-24 - PSR-7 HTTP Message implementation.
...
* [Symfony Panther](https://github.com/symfony/panther) ⭐ 3,070 | 🐛 211 | 🌐 PHP | 📅 2026-06-04 - A browser testing and web crawling library for PHP and Symfony.
...
* [Laminas Stratigility](https://github.com/laminas/laminas-stratigility) ⭐ 58 | 🐛 3 | 🌐 PHP | 📅 2026-09-21 - Middleware for PHP built on top of PSR-7.
...
* [PHP Domain Parser](https://github.com/jeremykendall/php-domain-parser) ⭐ 1,244 | 🐛 0 | 🌐 PHP | 📅 2026-01-30 - A domain suffix parser library.
* [Uri](https://github.com/thephpleague/uri) ⭐ 1,128 | 🐛 0 | 🌐 PHP | 📅 2026-09-26 - Another URL manipulation library.
...
* [PHPMailer](https://github.com/PHPMailer/PHPMailer) ⭐ 22,298 | 🐛 24 | 🌐 PHP | 📅 2026-09-20 - Another mailer solution.
* [Mautic](https://github.com/mautic/mautic) ⭐ 10,560 | 🐛 200 | 🌐 PHP | 📅 2026-09-25 - Email marketing automation.
...
* [Parquet](https://github.com/flow-php/parquet) ⭐ 62 | 🐛 0 | 🌐 PHP | 📅 2026-09-26 - PHP implementation of Parquet file format.
...
* [Symfony DI](https://github.com/symfony/dependency-injection) ⭐ 4,165 | 🐛 0 | 🌐 PHP | 📅 2026-09-26 - A dependency injection container component.
...
* [Intervention Image](https://github.com/Intervention/image) ⭐ 14,372 | 🐛 21 | 🌐 PHP | 📅 2026-09-26 - Another image manipulation library.
...
* [PHPUnit](https://github.com/sebastianbergmann/phpunit) ⭐ 20,058 | 🐛 23 | 🌐 PHP | 📅 2026-09-26 - A unit testing framework.
...
* [Codeception](https://github.com/Codeception/Codeception) ⭐ 4,859 | 🐛 168 | 🌐 PHP | 📅 2026-09-25 - A full stack testing framework.
* [Faker](https://github.com/fakerphp/faker) ⭐ 3,996 | 🐛 39 | 🌐 PHP | 📅 2026-05-02 - A fake data generator library.
* [Alice](https://github.com/nelmio/alice) ⭐ 2,539 | 🐛 52 | 🌐 PHP | 📅 2026-06-15 - An expressive fixture generation library.
* [ParaTest](https://github.com/paratestphp/paratest) ⭐ 2,509 | 🐛 10 | 🌐 PHP | 📅 2026-09-25 - A parallel testing library for PHPUnit.
* [Infection](https://github.com/infection/infection) ⭐ 2,243 | 🐛 219 | 🌐 PHP | 📅 2026-09-24 - An AST-based PHP Mutation testing framework.
...
* [Setup PHP](https://github.com/shivammathur/setup-php) ⭐ 3,260 | 🐛 10 | 🌐 TypeScript | 📅 2026-09-25 - A GitHub Action for PHP.
...
* [zircote/swagger-php](https://github.com/zircote/swagger-php) ⭐ 5,310 | 🐛 12 | 🌐 PHP | 📅 2026-09-26 - Generate OpenAPI documentation for your RESTful API.
* [Scramble](https://github.com/dedoc/scramble) ⭐ 2,214 | 🐛 18 | 🌐 PHP | 📅 2026-09-24 - Automatically generates OpenAPI documentation from your code without annotations.
...
* [SQLMap](https://github.com/sqlmapproject/sqlmap) ⭐ 38,521 | 🐛 31 | 🌐 Python | 📅 2026-09-25 - An automatic SQL injection and database takeover tool.
* [Zap](https://github.com/zaproxy/zaproxy) ⭐ 15,829 | 🐛 862 | 🌐 Java | 📅 2026-09-24 - An integrated penetration testing tool for web applications.
* [Halite](https://paragonie.com/project/halite) - A simple library for encryption using [libsodium](https://github.com/jedisct1/libsodium) ⭐ 13,964 | 🐛 1 | 🌐 C | 📅 2026-09-22.
* [PHPSecLib](https://github.com/phpseclib/phpseclib) ⭐ 5,592 | 🐛 208 | 🌐 PHP | 📅 2026-09-24 - A pure PHP secure communications library.
...
* [Roave Security Advisories](https://github.com/Roave/SecurityAdvisories) ⭐ 2,918 | 🐛 1 | 📅 2026-09-25 - This package ensures that your application doesn't have installed dependencies with known security vulnerabilities.
...
* [AntiXSS](https://github.com/voku/anti-xss) ⭐ 712 | 🐛 2 | 🌐 PHP | 📅 2026-09-25 - A library that tries to preventing Cross-Site Scripting (XSS) attacks by blacklisting.
...
* [Zxcvbn PHP](https://github.com/bjeavons/zxcvbn-php) ⭐ 871 | 🐛 25 | 🌐 PHP | 📅 2025-02-24 - A realistic PHP password strength estimate library based on Zxcvbn JS.
* [Password-Generator](https://github.com/hackzilla/password-generator) ⭐ 306 | 🐛 5 | 🌐 PHP | 📅 2024-09-01 - PHP library to generate random passwords.
...
* [Rector](https://github.com/rectorphp/rector) ⭐ 10,427 | 🐛 3 | 🌐 PHP | 📅 2026-09-24 - A tool to upgrade and refactor code.
* [GrumPHP](https://github.com/phpro/grumphp) ⭐ 4,316 | 🐛 7 | 🌐 PHP | 📅 2026-09-25 - A PHP code-quality tool.
* [Phpactor](https://github.com/phpactor/phpactor) ⭐ 1,928 | 🐛 292 | 🌐 PHP | 📅 2026-09-24 - PHP completion, refactoring and introspection tool.
...
* [Bladestan](https://github.com/bladestan/bladestan) ⭐ 375 | 🐛 24 | 🌐 PHP | 📅 2026-09-02 - A PHPStan extension for static analysis of Blade templates.
...
* [PHP CS Fixer](https://github.com/PHP-CS-Fixer/PHP-CS-Fixer) ⭐ 13,556 | 🐛 85 | 🌐 PHP | 📅 2026-09-25 - A coding standards fixer library.
* [Laravel Pint](https://github.com/laravel/pint) ⭐ 3,168 | 🐛 9 | 🌐 PHP | 📅 2026-09-10 - A coding standards fixer library for Laravel.
* [PHP Mess Detector](https://github.com/phpmd/phpmd) ⭐ 2,455 | 🐛 59 | 🌐 PHP | 📅 2026-09-24 - A library that scans code for bugs, sub-optimal code, unused parameters and more.
* [PHP CodeSniffer](https://github.com/PHPCSStandards/PHP_CodeSniffer) ⭐ 1,557 | 🐛 204 | 🌐 PHP | 📅 2026-09-26 - A library that detects and can auto-fix PHP, CSS and JS coding standard violations.
...
* [PHPStan](https://github.com/phpstan/phpstan) ⭐ 14,112 | 🐛 1,085 | 🌐 PHP | 📅 2026-09-26 - A PHP Static Analysis Tool.
* [Larastan](https://github.com/larastan/larastan) ⭐ 6,520 | 🐛 94 | 🌐 PHP | 📅 2026-09-24 - A PHPStan wrapper for Laravel that adds static analysis to Laravel projects.
* [Psalm](https://github.com/vimeo/psalm) ⭐ 5,889 | 🐛 2,082 | 🌐 PHP | 📅 2026-09-25 - A static analysis tool for finding errors in PHP applications.
* [phan](https://github.com/phan/phan) ⭐ 5,626 | 🐛 792 | 🌐 PHP | 📅 2026-09-15 - A static analyzer based on PHP 7+ and the php-ast extension.
* [Mago](https://github.com/carthage-software/mago) ⭐ 3,464 | 🐛 105 | 🌐 Rust | 📅 2026-09-24 - A toolchain for PHP that aims to improve the developer experience.
* [Deptrac](https://github.com/deptrac/deptrac) ⭐ 3,021 | 🐛 35 | 🌐 PHP | 📅 2026-09-20 - A static analysis tool for enforcing dependency rules between architectural layers.
* [PHP Metrics](https://github.com/phpmetrics/PhpMetrics) ⭐ 2,614 | 🐛 4 | 🌐 PHP | 📅 2026-08-21 - A static metric library.
* [PHPCompatibility](https://github.com/PHPCompatibility/PHPCompatibility) ⭐ 2,303 | 🐛 91 | 🌐 PHP | 📅 2026-09-25 - A PHP compatibility checker for PHP CodeSniffer.
* [PHPDoc Parser](https://github.com/phpstan/phpdoc-parser) ⭐ 1,536 | 🐛 25 | 🌐 PHP | 📅 2026-09-25 - Next-gen phpDoc parser with support for intersection types and generics.
...
* [Dead Code Detector](https://github.com/shipmonk-rnd/dead-code-detector) ⭐ 518 | 🐛 16 | 🌐 PHP | 📅 2026-09-25 - A PHPStan extension for finding unused PHP code.
...
* [Iter](https://github.com/nikic/iter) ⭐ 1,143 | 🐛 15 | 🌐 PHP | 📅 2026-09-23 - A library that provides iteration primitives using generators.
...
* [IterTools PHP](https://github.com/markrogoyski/itertools-php) ⭐ 152 | 🐛 1 | 🌐 PHP | 📅 2026-09-22 - A library that provides functionality for working with iterable entities (similar to itertools library in Python).
...
* [xDebug](https://github.com/xdebug/xdebug) ⭐ 3,417 | 🐛 9 | 🌐 PHP | 📅 2026-09-08 - A debug and profile tool for PHP.
...
* [PHPBench](https://github.com/phpbench/phpbench) ⭐ 2,024 | 🐛 39 | 🌐 PHP | 📅 2026-06-14 - A benchmarking framework.
* [Tracy](https://github.com/nette/tracy) ⭐ 1,839 | 🐛 27 | 🌐 PHP | 📅 2026-08-18 - A simple error detection, logging and time measuring library.
* [PHPSpy](https://github.com/adsr/phpspy) ⭐ 1,499 | 🐛 24 | 🌐 C | 📅 2026-09-07 - A low-overhead sampling profiler.
...
* [LaraDumps](https://github.com/laradumps/laradumps) ⭐ 1,271 | 🐛 3 | 🌐 PHP | 📅 2026-09-24 - A debugging tool for Laravel with a dedicated desktop application.
* [PCOV](https://github.com/krakjoe/pcov) ⭐ 794 | 🐛 36 | 🌐 C | 📅 2026-07-21 - A self-contained code coverage compatible driver.
* [PHP Console](https://github.com/Seldaek/php-console) ⭐ 524 | 🐛 6 | 🌐 PHP | 📅 2021-03-14 - A web debugging console.
* [Metrics](https://github.com/beberlei/metrics) ⭐ 338 | 🐛 0 | 🌐 PHP | 📅 2026-09-09 - A simple metrics API library.
* [Trap](https://github.com/buggregator/trap) ⭐ 276 | 🐛 34 | 🌐 PHP | 📅 2026-09-08 - An extended variable dumper with a web interface and IDE plugin.
...
* [Box](https://github.com/box-project/box) ⭐ 1,321 | 🐛 102 | 🌐 PHP | 📅 2026-06-29 - A utility to build PHAR files.
...
* [KnpMenu](https://github.com/KnpLabs/KnpMenu) ⭐ 1,396 | 🐛 22 | 🌐 PHP | 📅 2026-08-21 - A menu library.
...
* [Symfony Encore](https://github.com/symfony/webpack-encore) ⭐ 2,221 | 🐛 11 | 🌐 JavaScript | 📅 2026-09-18 - A simple but powerful API for processing and compiling assets built around Webpack.
...
* [Carbon](https://github.com/briannesbitt/Carbon) ⭐ 16,596 | 🐛 3 | 🌐 PHP | 📅 2026-09-25 - A simple DateTime API extension.
...
* [Yasumi](https://github.com/azuyalabs/yasumi) ⭐ 1,105 | 🐛 8 | 🌐 PHP | 📅 2026-09-11 - A library to help you calculate the dates and names of holidays.
...
* [Swoole](https://github.com/swoole/swoole-src) ⭐ 18,923 | 🐛 62 | 🌐 C++ | 📅 2026-09-25 - An event-driven asynchronous and concurrent networking communication framework with high performance for PHP written in C.
* [Workerman](https://github.com/walkor/Workerman) ⭐ 11,550 | 🐛 109 | 🌐 PHP | 📅 2026-08-29 - An event-driven non-blocking I/O library.
...
* [Money](https://github.com/moneyphp/money) ⭐ 4,867 | 🐛 6 | 🌐 PHP | 📅 2026-07-07 - A PHP implementation of Fowler's money pattern.
* [Shopware](https://github.com/shopware/shopware) ⭐ 3,432 | 🐛 1,486 | 🌐 PHP | 📅 2026-09-25 - Highly customizable e-commerce software.
* [Brick Money](https://github.com/brick/money) ⭐ 1,928 | 🐛 5 | 🌐 PHP | 📅 2026-09-25 - A money library for PHP, with support for contexts, cash roundings, currency conversion.
...
* [Shopsys Framework](https://github.com/shopsys/shopsys/) ⭐ 350 | 🐛 132 | 🌐 PHP | 📅 2026-09-25 - An open source e-commerce platform for in-house development teams.
...
* [Dompdf](https://github.com/dompdf/dompdf) ⭐ 11,192 | 🐛 547 | 🌐 PHP | 📅 2026-08-02 - A HTML to PDF converter.
...
* [PHPSpreadsheet](https://github.com/PHPOffice/PhpSpreadsheet) ⭐ 13,989 | 🐛 99 | 🌐 PHP | 📅 2026-09-23 - A pure PHP library for reading and writing spreadsheet files (successor of PHPExcel).
* [PHPWord](https://github.com/PHPOffice/PHPWord) ⭐ 7,593 | 🐛 1,230 | 🌐 PHP | 📅 2026-09-24 - A library for working with Microsoft Word documents.
* [PHPPowerPoint](https://github.com/PHPOffice/PHPPresentation) ⭐ 1,372 | 🐛 243 | 🌐 PHP | 📅 2026-09-25 - A library for working with Microsoft PowerPoint Presentations.
* [OpenSpout](https://github.com/openspout/openspout) ⭐ 1,246 | 🐛 7 | 🌐 PHP | 📅 2026-09-25 - A community driven fork of `box/spout`, a PHP library to read and write spreadsheet files (CSV, XLSX and ODS), in a fast and scalable way.

### Database

*Libraries for interacting with databases using object-relational mapping (ORM) or datamapping techniques.*

* [ProxyManager](https://github.com/Ocramius/ProxyManager) ⭐ 4,941 | 🐛 55 | 🌐 PHP | 📅 2026-09-25 - A set of utilities to generate proxy objects for data mappers.
* [Doctrine Extensions](https://github.com/doctrine-extensions/DoctrineExtensions) ⭐ 4,138 | 🐛 55 | 🌐 PHP | 📅 2026-09-22 - A collection of Doctrine behavioural extensions.
* [Laravel Eloquent](https://github.com/illuminate/database) ⭐ 2,774 | 🐛 7 | 🌐 PHP | 📅 2026-09-26 - A simple ORM.
...
* [Aura.Sql](https://github.com/auraphp/Aura.Sql) ⭐ 567 | 🐛 2 | 🌐 PHP | 📅 2026-09-20 - Provides an extension to the native PDO along with a profiler and connection locator.
...
* [CakePHP ORM](https://github.com/cakephp/orm) ⭐ 150 | 🐛 1 | 🌐 PHP | 📅 2026-09-22 - Object-Relational Mapper, implemented using the DataMapper pattern.
...
* [Predis](https://github.com/predis/predis) ⭐ 7,780 | 🐛 27 | 🌐 PHP | 📅 2026-09-25 - A feature-complete Redis library.
* [MongoDB PHP Library](https://github.com/mongodb/mongo-php-library) ⭐ 1,612 | 🐛 6 | 🌐 PHP | 📅 2026-09-25 - The official high-level MongoDB PHP library built on top of the MongoDB PHP Driver.
* [MongoDB](https://github.com/mongodb/mongo-php-driver) ⭐ 923 | 🐛 6 | 🌐 PHP | 📅 2026-09-25 - MongoDB PHP Driver.

### Queue

*Libraries for working with event and task queues.*

* [PHP AMQP](https://github.com/php-amqplib/php-amqplib) ⭐ 4,602 | 🐛 25 | 🌐 PHP | 📅 2026-09-25 - A pure PHP AMQP library.
...
* [Pheanstalk](https://github.com/pheanstalk/pheanstalk) ⭐ 1,920 | 🐛 7 | 🌐 PHP | 📅 2026-03-06 - A Beanstalkd client library.
...
* [ElasticSearch PHP](https://github.com/elastic/elasticsearch-php) ⭐ 5,336 | 🐛 22 | 🌐 PHP | 📅 2026-09-21 - The official client library for [ElasticSearch](https://www.elastic.co/).
...
* [PsySH](https://github.com/bobthecow/psysh) ⭐ 9,832 | 🐛 9 | 🌐 PHP | 📅 2026-09-23 - Another PHP REPL.
...
* [Json Web Token](https://github.com/lcobucci/jwt) ⭐ 7,479 | 🐛 9 | 🌐 PHP | 📅 2026-09-26 - Json Tokens to authenticate and transmit information.
* [TwitterOAuth](https://github.com/abraham/twitteroauth) ⭐ 4,299 | 🐛 10 | 🌐 PHP | 📅 2026-09-22 - A Twitter OAuth library.
* [OAuth 2.0 Client](https://github.com/thephpleague/oauth2-client) ⭐ 3,818 | 🐛 63 | 🌐 PHP | 📅 2026-09-16 - An OAuth 2.0 client library.
...
* [Parsedown](https://github.com/erusev/parsedown) ⭐ 15,057 | 🐛 178 | 🌐 PHP | 📅 2026-02-18 - Another Markdown parser.
* [PHP Markdown](https://github.com/michelf/php-markdown) ⭐ 3,462 | 🐛 98 | 🌐 PHP | 📅 2025-06-17 - A Markdown parser.
* [CommonMark PHP](https://github.com/thephpleague/commonmark) ⭐ 2,978 | 🐛 18 | 🌐 PHP | 📅 2026-09-26 - Highly-extensible Markdown parser which fully supports the [CommonMark spec](https://spec.commonmark.org/).
* [HTML to Markdown](https://github.com/thephpleague/html-to-markdown) ⭐ 1,905 | 🐛 21 | 🌐 PHP | 📅 2026-09-07 - Converts HTML into Markdown.
* [PHP CSS Parser](https://github.com/MyIntervals/PHP-CSS-Parser) ⭐ 1,829 | 🐛 161 | 🌐 PHP | 📅 2026-09-25 - A Parser for CSS Files written in PHP.
* [HTML5 PHP](https://github.com/Masterminds/html5-php) ⭐ 1,784 | 🐛 38 | 🌐 HTML | 📅 2026-08-18 - An HTML5 parser and serializer library.
...
* [VObject](https://github.com/sabre-io/vobject) ⭐ 603 | 🐛 107 | 🌐 PHP | 📅 2026-09-04 - A library for parsing VCard and iCalendar objects.
* [Embera](https://github.com/mpratt/Embera) ⭐ 354 | 🐛 6 | 🌐 PHP | 📅 2025-10-07 - An Oembed consumer library.
* [Shiki PHP](https://github.com/spatie/shiki-php) ⭐ 315 | 🐛 0 | 🌐 JavaScript | 📅 2026-04-27 - A [Shiki](https://github.com/shikijs/shiki) ⭐ 13,830 | 🐛 111 | 🌐 TypeScript | 📅 2026-09-11 code highlighting package in PHP.
* [Decoda](https://github.com/milesj/decoda) ⭐ 192 | 🐛 9 | 🌐 PHP | 📅 2022-11-10 - A lightweight markup parser library.
* [Djot](https://github.com/php-collective/djot-php) ⭐ 25 | 🐛 1 | 🌐 PHP | 📅 2026-09-23 - A PHP parser for [Djot](https://djot.net/), a modern light markup language (successor of Markdown).
...
* [UUID](https://github.com/ramsey/uuid) ⭐ 12,631 | 🐛 25 | 🌐 PHP | 📅 2026-09-17 - A library for generating UUIDs.
...
* [Device Detector](https://github.com/matomo-org/device-detector) ⭐ 3,529 | 🐛 76 | 🌐 PHP | 📅 2026-09-23 - Another library for parsing user agent strings.
...
* [Portable UTF-8](https://github.com/voku/portable-utf8) ⭐ 519 | 🐛 4 | 🌐 PHP | 📅 2026-07-06 - A string manipulation library with UTF-8 safe replacement methods.
...
* [Stringy](https://github.com/voku/Stringy) ⭐ 180 | 🐛 2 | 🌐 PHP | 📅 2026-09-24 - A string manipulation library with multibyte support.
* [Url highlight](https://github.com/vstelmakh/url-highlight) ⭐ 103 | 🐛 0 | 🌐 PHP | 📅 2026-09-24 - A library for parsing URLs from text and converting them into clickable links.
...
* [Brick Math](https://github.com/brick/math) ⭐ 2,176 | 🐛 0 | 🌐 PHP | 📅 2026-09-25 - A library providing large number support: `BigInteger`, `BigDecimal` and `BigRational`.
...
* [Respect Validation](https://github.com/Respect/Validation) ⭐ 6,031 | 🐛 16 | 🌐 PHP | 📅 2026-09-26 - A simple validation library.
* [LibPhoneNumber for PHP](https://github.com/giggsey/libphonenumber-for-php) ⭐ 5,061 | 🐛 1 | 🌐 PHP | 📅 2026-09-24 - A PHP implementation of Google's phone number handling library.
* [JSON Schema](https://github.com/jsonrainbow/json-schema) ⭐ 3,630 | 🐛 24 | 🌐 PHP | 📅 2026-09-24 - A [JSON Schema](https://json-schema.org/) validation library.
* [HTML Purifier](https://github.com/ezyang/htmlpurifier) ⭐ 3,353 | 🐛 131 | 🌐 PHP | 📅 2026-09-15 - A standards compliant HTML filter.
* [Assert](https://github.com/beberlei/assert) ⭐ 2,432 | 🐛 50 | 🌐 PHP | 📅 2026-06-10 - A validation library with a rich set of assertions. Supports assertion chaining and lazy assertions.
...
* [ISO-codes](https://github.com/ronanguilloux/IsoCodes) ⭐ 803 | 🐛 5 | 🌐 PHP | 📅 2026-03-20 - A library for validating inputs according to standards from ISO, International Finance, Public Administrations, GS1, Book Industry, Phone numbers & Zipcodes for many countries.
* [Filterus](https://github.com/ircmaxell/filterus) ⭐ 443 | 🐛 8 | 🌐 PHP | 📅 2018-11-21 - A simple PHP filtering library.
* [Symfony HTML Sanitizer](https://github.com/symfony/html-sanitizer) ⭐ 281 | 🐛 0 | 🌐 PHP | 📅 2026-09-24 - An HTML sanitizer library.
...
* [CakePHP Validation](https://github.com/cakephp/validation) ⭐ 43 | 🐛 0 | 🌐 PHP | 📅 2026-09-21 - Another validation library.
...
* [Restler](https://github.com/Luracast/Restler) ⭐ 1,384 | 🐛 33 | 🌐 PHP | 📅 2026-08-22 - A lightweight framework to expose PHP methods as RESTful web API.
* [Hateoas](https://github.com/willdurand/Hateoas) ⭐ 1,042 | 🐛 33 | 🌐 PHP | 📅 2026-01-10 - A HATEOAS REST web service library.
* [Jane](https://github.com/janephp/janephp/) ⭐ 691 | 🐛 13 | 🌐 PHP | 📅 2026-09-25 - An OpenApi client generator with validation support.
...
* [CacheTool](https://github.com/gordalina/cachetool) ⭐ 1,829 | 🐛 18 | 🌐 PHP | 📅 2026-01-28 - A tool to clear APC/opcode caches from the command line.
...
* [Laminas Cache](https://github.com/laminas/laminas-cache) ⭐ 107 | 🐛 16 | 🌐 PHP | 📅 2026-09-25 - Another caching library.
...
* [CakePHP Cache](https://github.com/cakephp/cache) ⭐ 50 | 🐛 0 | 🌐 PHP | 📅 2026-09-21 - A caching library.
...
* [YaLinqo](https://github.com/Athari/YaLinqo) ⭐ 454 | 🐛 13 | 🌐 PHP | 📅 2025-10-19 - Yet Another LINQ to Objects for PHP.
* [msgpack.php](https://github.com/rybakit/msgpack.php) ⭐ 409 | 🐛 1 | 🌐 PHP | 📅 2026-09-25 - A pure PHP implementation of the [MessagePack](https://msgpack.org/) serialization format.
* [CakePHP Collection](https://github.com/cakephp/collection) ⭐ 91 | 🐛 0 | 🌐 PHP | 📅 2026-09-06 - A simple collections library.
* [Laminas Serializer](https://github.com/laminas/laminas-serializer) ⭐ 36 | 🐛 6 | 🌐 PHP | 📅 2026-09-21 - Another library for serialising and de-serialising data.

### Notifications

*Libraries for working with notification software.*

* [JoliNotif](https://github.com/jolicode/JoliNotif) ⭐ 1,442 | 🐛 3 | 🌐 PHP | 📅 2026-09-23 - A cross-platform library for desktop notification (support for Growl, notify-send, toaster, etc).
...
* [CakePHP I18n](https://github.com/cakephp/i18n) ⭐ 29 | 🐛 0 | 🌐 PHP | 📅 2026-09-21 - Message translation and localization for dates and numbers.
...
* [OpenAI Client](https://github.com/openai-php/client) ⭐ 5,833 | 🐛 26 | 🌐 PHP | 📅 2026-09-23 - OpenAI PHP is a supercharged community-maintained PHP API client that allows you to interact with OpenAI API.
...
* [LLPhant](https://github.com/LLPhant/LLPhant) ⭐ 1,711 | 🐛 36 | 🌐 PHP | 📅 2026-09-25 - A comprehensive PHP Generative AI Framework using OpenAI GPT 4. Inspired by Langchain.
* [Instructor for PHP](https://github.com/cognesy/instructor-php) ⭐ 327 | 🐛 2 | 🌐 PHP | 📅 2026-09-25 - Structured data outputs with LLMs, in PHP.
...
* [Amazon Web Service SDK](https://github.com/aws/aws-sdk-php) ⭐ 6,204 | 🐛 20 | 🌐 PHP | 📅 2026-09-25 - The official PHP AWS SDK library.
* [Stripe](https://github.com/stripe/stripe-php) ⭐ 4,019 | 🐛 15 | 🌐 PHP | 📅 2026-09-25 - The official Stripe PHP library.
* [Github](https://github.com/KnpLabs/php-github-api) ⭐ 2,206 | 🐛 52 | 🌐 PHP | 📅 2026-08-18 - A library to interface with the Github API.
* [Twilio](https://github.com/twilio/twilio-php) ⭐ 1,636 | 🐛 61 | 🌐 PHP | 📅 2026-09-25 - The official Twilio PHP REST API.
...
* [Zephir](https://github.com/zephir-lang/zephir) ⭐ 3,385 | 🐛 55 | 🌐 PHP | 📅 2026-09-26 - A compiled language between PHP and C++ for developing PHP extensions.
...
* [BotMan](https://github.com/botman/botman) ⭐ 6,159 | 🐛 10 | 🌐 PHP | 📅 2026-04-03 - A framework agnostic PHP library to build cross-platform chatbots.
...
* [Laravel Serializable Closure](https://github.com/laravel/serializable-closure) ⭐ 609 | 🐛 2 | 🌐 PHP | 📅 2026-09-22 - A library that allows Closures to be serialized.
...
* [Static PHP CLI](https://github.com/crazywhalecc/static-php-cli) ⭐ 1,943 | 🐛 38 | 🌐 PHP | 📅 2026-09-24 - Build or [download](https://dl.static-php.dev/static-php-cli/) static versions of PHP CLI and FPM.
...
* [Docker PHP Extension Installer](https://github.com/mlocati/docker-php-extension-installer) ⭐ 4,974 | 🐛 10 | 🌐 Shell | 📅 2026-09-25 - Easily install PHP extensions in Docker containers.
* [Expose](https://github.com/exposedev/expose) ⭐ 4,573 | 🐛 28 | 🌐 PHP | 📅 2026-09-17 - An open-source PHP tunneling service.
* [DDEV](https://github.com/ddev/ddev) ⭐ 3,896 | 🐛 177 | 🌐 Go | 📅 2026-09-26 - A local web development environment system for PHP.
...
* [HHVM](https://github.com/facebook/hhvm) ⭐ 18,666 | 🐛 547 | 🌐 C++ | 📅 2026-09-26 - A Virtual Machine, Runtime and JIT for PHP by Facebook.
* [PeachPie](https://github.com/peachpiecompiler/peachpie) ⭐ 2,483 | 🐛 90 | 🌐 C# | 📅 2026-09-22 - PHP compiler and runtime for .NET and .NET Core.
...
* [Mailpit](https://github.com/axllent/mailpit) ⭐ 10,453 | 🐛 0 | 🌐 Go | 📅 2026-09-20 - An email and SMTP testing tool for developers.
* [phpMyAdmin](https://github.com/phpmyadmin/phpmyadmin) ⭐ 7,939 | 🐛 928 | 🌐 PHP | 📅 2026-09-26 - A web interface for MySQL/MariaDB.
...
* [RoadRunner](https://github.com/roadrunner-server/roadrunner) ⭐ 8,509 | 🐛 52 | 🌐 Go | 📅 2026-09-21 - High-performance PHP application server, load-balancer and process manager.
...
* [appserver.io](https://github.com/appserver-io/appserver) ⭐ 961 | 🐛 90 | 🌐 JavaScript | 📅 2023-04-15 - A multithreaded application server for PHP, written in PHP.
