...
Please see [CONTRIBUTING](https://github.com/ziadoz/awesome-php/blob/master/CONTRIBUTING.md) ⭐ 32,675 | 🐛 85 | 📅 2026-07-13, [CODE-OF-CONDUCT](https://github.com/ziadoz/awesome-php/blob/master/CODE-OF-CONDUCT.md) ⭐ 32,675 | 🐛 85 | 📅 2026-07-13 and [COLLABORATING](https://github.com/ziadoz/awesome-php/blob/master/COLLABORATING.md) ⭐ 32,675 | 🐛 85 | 📅 2026-07-13 for details.
...
* [Pie](https://github.com/php/pie) ⭐ 2,001 | 🐛 14 | 🌐 PHP | 📅 2026-08-19 - The official PHP installer for extensions.
...
* [Yii2](https://github.com/yiisoft/yii2/) ⭐ 14,299 | 🐛 333 | 🌐 PHP | 📅 2026-08-20 - A fast, secure, and efficient web framework.
* [Tempest](https://github.com/tempestphp/tempest-framework) ⭐ 2,259 | 🐛 32 | 🌐 PHP | 📅 2026-08-28 - A framework that gets out of your way.
...
* [WordPress](https://github.com/WordPress/WordPress) ⭐ 21,373 | 🐛 3 | 🌐 PHP | 📅 2026-08-30 - A blogging platform and CMS.
* [Grav](https://github.com/getgrav/grav) ⭐ 15,655 | 🐛 447 | 🌐 PHP | 📅 2026-08-28 - A modern flat-file CMS.
* [Magento](https://github.com/magento/magento2) ⭐ 12,171 | 🐛 2,136 | 🌐 PHP | 📅 2026-08-28 - A widely used open-source e-commerce platform.
* [CraftCMS](https://github.com/craftcms/cms) ⭐ 3,606 | 🐛 545 | 🌐 PHP | 📅 2026-08-30 - A flexible, user-friendly CMS for creating custom digital experiences on the web and beyond.
...
* [Laminas Diactoros](https://github.com/laminas/laminas-diactoros) ⭐ 560 | 🐛 32 | 🌐 PHP | 📅 2026-08-29 - PSR-7 HTTP Message implementation.
...
* [PHPMailer](https://github.com/PHPMailer/PHPMailer) ⭐ 22,284 | 🐛 30 | 🌐 PHP | 📅 2026-08-20 - Another mailer solution.
* [Mautic](https://github.com/mautic/mautic) ⭐ 10,417 | 🐛 192 | 🌐 PHP | 📅 2026-08-30 - Email marketing automation.
...
* [Flysystem](https://github.com/thephpleague/Flysystem) ⭐ 13,585 | 🐛 105 | 🌐 PHP | 📅 2026-08-22 - Abstraction for local and remote filesystems.
...
* [PHPUnit](https://github.com/sebastianbergmann/phpunit) ⭐ 20,046 | 🐛 21 | 🌐 PHP | 📅 2026-08-30 - A unit testing framework.
...
* [ParaTest](https://github.com/paratestphp/paratest) ⭐ 2,496 | 🐛 6 | 🌐 PHP | 📅 2026-08-30 - A parallel testing library for PHPUnit.
* [Infection](https://github.com/infection/infection) ⭐ 2,237 | 🐛 211 | 🌐 PHP | 📅 2026-08-29 - An AST-based PHP Mutation testing framework.
...
* [zircote/swagger-php](https://github.com/zircote/swagger-php) ⭐ 5,305 | 🐛 15 | 🌐 PHP | 📅 2026-08-30 - Generate OpenAPI documentation for your RESTful API.
...
* [daux.io](https://github.com/dauxio/daux.io) ⭐ 829 | 🐛 8 | 🌐 PHP | 📅 2026-08-29 - A documentation generator that uses Markdown files.
...
* [SQLMap](https://github.com/sqlmapproject/sqlmap) ⭐ 38,315 | 🐛 34 | 🌐 Python | 📅 2026-08-28 - An automatic SQL injection and database takeover tool.
* [Zap](https://github.com/zaproxy/zaproxy) ⭐ 15,707 | 🐛 858 | 🌐 Java | 📅 2026-08-27 - An integrated penetration testing tool for web applications.
* [Halite](https://paragonie.com/project/halite) - A simple library for encryption using [libsodium](https://github.com/jedisct1/libsodium) ⭐ 13,921 | 🐛 1 | 🌐 C | 📅 2026-08-28.
* [PHPSecLib](https://github.com/phpseclib/phpseclib) ⭐ 5,585 | 🐛 209 | 🌐 PHP | 📅 2026-08-29 - A pure PHP secure communications library.
* [PHPGGC](https://github.com/ambionics/phpggc) ⭐ 3,878 | 🐛 21 | 🌐 PHP | 📅 2025-09-29 - A library of PHP unserializable payloads along with a tool to generate them.
...
* [AntiXSS](https://github.com/voku/anti-xss) ⭐ 712 | 🐛 3 | 🌐 PHP | 📅 2026-08-30 - A library that tries to preventing Cross-Site Scripting (XSS) attacks by blacklisting.
...
* [Rector](https://github.com/rectorphp/rector) ⭐ 10,407 | 🐛 3 | 🌐 PHP | 📅 2026-08-30 - A tool to upgrade and refactor code.
* [GrumPHP](https://github.com/phpro/grumphp) ⭐ 4,311 | 🐛 6 | 🌐 PHP | 📅 2026-08-11 - A PHP code-quality tool.
* [Phpactor](https://github.com/phpactor/phpactor) ⭐ 1,921 | 🐛 292 | 🌐 PHP | 📅 2026-08-26 - PHP completion, refactoring and introspection tool.
* [Better Reflection](https://github.com/Roave/BetterReflection) ⭐ 1,246 | 🐛 17 | 🌐 PHP | 📅 2026-08-30 - An AST-based reflection library that allows analysis and manipulation of code.
...
* [PHP CS Fixer](https://github.com/PHP-CS-Fixer/PHP-CS-Fixer) ⭐ 13,547 | 🐛 87 | 🌐 PHP | 📅 2026-08-30 - A coding standards fixer library.
* [Laravel Pint](https://github.com/laravel/pint) ⭐ 3,158 | 🐛 13 | 🌐 PHP | 📅 2026-08-17 - A coding standards fixer library for Laravel.
* [PHP Mess Detector](https://github.com/phpmd/phpmd) ⭐ 2,450 | 🐛 63 | 🌐 PHP | 📅 2026-08-23 - A library that scans code for bugs, sub-optimal code, unused parameters and more.
* [PHP CodeSniffer](https://github.com/PHPCSStandards/PHP_CodeSniffer) ⭐ 1,553 | 🐛 199 | 🌐 PHP | 📅 2026-08-21 - A library that detects and can auto-fix PHP, CSS and JS coding standard violations.
...
* [PHPStan](https://github.com/phpstan/phpstan) ⭐ 14,088 | 🐛 1,133 | 🌐 PHP | 📅 2026-08-27 - A PHP Static Analysis Tool.
* [Larastan](https://github.com/larastan/larastan) ⭐ 6,498 | 🐛 120 | 🌐 PHP | 📅 2026-08-29 - A PHPStan wrapper for Laravel that adds static analysis to Laravel projects.
* [Psalm](https://github.com/vimeo/psalm) ⭐ 5,886 | 🐛 2,101 | 🌐 PHP | 📅 2026-07-13 - A static analysis tool for finding errors in PHP applications.
* [phan](https://github.com/phan/phan) ⭐ 5,624 | 🐛 794 | 🌐 PHP | 📅 2026-08-26 - A static analyzer based on PHP 7+ and the php-ast extension.
* [Mago](https://github.com/carthage-software/mago) ⭐ 3,415 | 🐛 103 | 🌐 Rust | 📅 2026-08-29 - A toolchain for PHP that aims to improve the developer experience.
...
* [PHPDoc Parser](https://github.com/phpstan/phpdoc-parser) ⭐ 1,533 | 🐛 17 | 🌐 PHP | 📅 2026-08-29 - Next-gen phpDoc parser with support for intersection types and generics.
...
* [Symfony VarDumper](https://github.com/symfony/var-dumper) ⭐ 7,428 | 🐛 0 | 🌐 PHP | 📅 2026-08-30 - A variable dumper component.
...
* [Chronos](https://github.com/cakephp/chronos) ⭐ 1,362 | 🐛 3 | 🌐 PHP | 📅 2026-08-30 - A DateTime API extension supporting both mutable and immutable date/time.
...
* [Swoole](https://github.com/swoole/swoole-src) ⭐ 18,915 | 🐛 46 | 🌐 C++ | 📅 2026-08-17 - An event-driven asynchronous and concurrent networking communication framework with high performance for PHP written in C.
...
* [Monolog](https://github.com/Seldaek/monolog) ⭐ 21,403 | 🐛 19 | 🌐 PHP | 📅 2026-08-28 - A comprehensive logger.

### E-commerce

*Libraries and applications for taking payments and building online e-commerce stores.*

* [OmniPay](https://github.com/thephpleague/omnipay) ⭐ 6,058 | 🐛 109 | 🌐 PHP | 📅 2026-07-10 - A framework agnostic multi-gateway payment processing library.
* [Money](https://github.com/moneyphp/money) ⭐ 4,862 | 🐛 4 | 🌐 PHP | 📅 2026-07-07 - A PHP implementation of Fowler's money pattern.
* [Shopware](https://github.com/shopware/shopware) ⭐ 3,411 | 🐛 1,329 | 🌐 PHP | 📅 2026-08-29 - Highly customizable e-commerce software.
...
* [Shopsys Framework](https://github.com/shopsys/shopsys/) ⭐ 349 | 🐛 124 | 🌐 PHP | 📅 2026-08-30 - An open source e-commerce platform for in-house development teams.
...
* [PHPSpreadsheet](https://github.com/PHPOffice/PhpSpreadsheet) ⭐ 13,981 | 🐛 101 | 🌐 PHP | 📅 2026-08-22 - A pure PHP library for reading and writing spreadsheet files (successor of PHPExcel).
* [PHPWord](https://github.com/PHPOffice/PHPWord) ⭐ 7,585 | 🐛 1,248 | 🌐 PHP | 📅 2026-08-27 - A library for working with Microsoft Word documents.
* [PHPPowerPoint](https://github.com/PHPOffice/PHPPresentation) ⭐ 1,373 | 🐛 249 | 🌐 PHP | 📅 2026-08-26 - A library for working with Microsoft PowerPoint Presentations.
* [OpenSpout](https://github.com/openspout/openspout) ⭐ 1,226 | 🐛 10 | 🌐 PHP | 📅 2026-08-28 - A community driven fork of `box/spout`, a PHP library to read and write spreadsheet files (CSV, XLSX and ODS), in a fast and scalable way.

### Database

*Libraries for interacting with databases using object-relational mapping (ORM) or datamapping techniques.*

* [ProxyManager](https://github.com/Ocramius/ProxyManager) ⭐ 4,943 | 🐛 55 | 🌐 PHP | 📅 2026-08-30 - A set of utilities to generate proxy objects for data mappers.
...
* [Laravel Eloquent](https://github.com/illuminate/database) ⭐ 2,772 | 🐛 7 | 🌐 PHP | 📅 2026-08-28 - A simple ORM.
...
* [PHP AMQP](https://github.com/php-amqplib/php-amqplib) ⭐ 4,603 | 🐛 24 | 🌐 PHP | 📅 2026-01-06 - A pure PHP AMQP library.
...
* [TwitterOAuth](https://github.com/abraham/twitteroauth) ⭐ 4,303 | 🐛 11 | 🌐 PHP | 📅 2026-08-24 - A Twitter OAuth library.
...
* [CommonMark PHP](https://github.com/thephpleague/commonmark) ⭐ 2,971 | 🐛 20 | 🌐 PHP | 📅 2026-08-30 - Highly-extensible Markdown parser which fully supports the [CommonMark spec](https://spec.commonmark.org/).
* [HTML to Markdown](https://github.com/thephpleague/html-to-markdown) ⭐ 1,904 | 🐛 21 | 🌐 PHP | 📅 2026-08-10 - Converts HTML into Markdown.
* [PHP CSS Parser](https://github.com/MyIntervals/PHP-CSS-Parser) ⭐ 1,826 | 🐛 158 | 🌐 PHP | 📅 2026-08-29 - A Parser for CSS Files written in PHP.
...
* [Shiki PHP](https://github.com/spatie/shiki-php) ⭐ 312 | 🐛 0 | 🌐 JavaScript | 📅 2026-04-27 - A [Shiki](https://github.com/shikijs/shiki) ⭐ 13,761 | 🐛 114 | 🌐 TypeScript | 📅 2026-08-10 code highlighting package in PHP.
...
* [Device Detector](https://github.com/matomo-org/device-detector) ⭐ 3,520 | 🐛 76 | 🌐 PHP | 📅 2026-08-30 - Another library for parsing user agent strings.
...
* [Respect Validation](https://github.com/Respect/Validation) ⭐ 6,028 | 🐛 12 | 🌐 PHP | 📅 2026-08-30 - A simple validation library.
...
* [JSON Schema](https://github.com/jsonrainbow/json-schema) ⭐ 3,630 | 🐛 23 | 🌐 PHP | 📅 2026-08-21 - A [JSON Schema](https://json-schema.org/) validation library.
...
* [Jane](https://github.com/janephp/janephp/) ⭐ 689 | 🐛 16 | 🌐 PHP | 📅 2026-08-29 - An OpenApi client generator with validation support.
...
* [Amazon Web Service SDK](https://github.com/aws/aws-sdk-php) ⭐ 6,203 | 🐛 22 | 🌐 PHP | 📅 2026-08-29 - The official PHP AWS SDK library.
* [Stripe](https://github.com/stripe/stripe-php) ⭐ 4,019 | 🐛 14 | 🌐 PHP | 📅 2026-08-29 - The official Stripe PHP library.
...
* [Zephir](https://github.com/zephir-lang/zephir) ⭐ 3,386 | 🐛 45 | 🌐 PHP | 📅 2026-08-30 - A compiled language between PHP and C++ for developing PHP extensions.
...
* [Docker PHP Extension Installer](https://github.com/mlocati/docker-php-extension-installer) ⭐ 4,965 | 🐛 13 | 🌐 Shell | 📅 2026-08-29 - Easily install PHP extensions in Docker containers.
* [Expose](https://github.com/exposedev/expose) ⭐ 4,568 | 🐛 28 | 🌐 PHP | 📅 2026-07-09 - An open-source PHP tunneling service.
* [DDEV](https://github.com/ddev/ddev) ⭐ 3,818 | 🐛 165 | 🌐 Go | 📅 2026-08-30 - A local web development environment system for PHP.
...
* [HHVM](https://github.com/facebook/hhvm) ⭐ 18,656 | 🐛 544 | 🌐 C++ | 📅 2026-08-30 - A Virtual Machine, Runtime and JIT for PHP by Facebook.
...
* [Mailpit](https://github.com/axllent/mailpit) ⭐ 10,229 | 🐛 0 | 🌐 Go | 📅 2026-08-29 - An email and SMTP testing tool for developers.
* [phpMyAdmin](https://github.com/phpmyadmin/phpmyadmin) ⭐ 7,919 | 🐛 940 | 🌐 PHP | 📅 2026-08-30 - A web interface for MySQL/MariaDB.
