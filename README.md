...
Please see [CONTRIBUTING](https://github.com/ziadoz/awesome-php/blob/master/CONTRIBUTING.md) ⭐ 32,707 | 🐛 92 | 📅 2026-07-13, [CODE-OF-CONDUCT](https://github.com/ziadoz/awesome-php/blob/master/CODE-OF-CONDUCT.md) ⭐ 32,707 | 🐛 92 | 📅 2026-07-13 and [COLLABORATING](https://github.com/ziadoz/awesome-php/blob/master/COLLABORATING.md) ⭐ 32,707 | 🐛 92 | 📅 2026-07-13 for details.
...
* [Pie](https://github.com/php/pie) ⭐ 2,022 | 🐛 17 | 🌐 PHP | 📅 2026-09-18 - The official PHP installer for extensions.
...
* [Composer Normalize](https://github.com/ergebnis/composer-normalize) ⭐ 1,126 | 🐛 12 | 🌐 PHP | 📅 2026-09-24 - A plugin for normalizing `composer.json` files.
...
* [Yii2](https://github.com/yiisoft/yii2/) ⭐ 14,289 | 🐛 335 | 🌐 PHP | 📅 2026-09-23 - A fast, secure, and efficient web framework.
...
* [WordPress](https://github.com/WordPress/WordPress) ⭐ 21,433 | 🐛 3 | 🌐 PHP | 📅 2026-09-24 - A blogging platform and CMS.
* [Grav](https://github.com/getgrav/grav) ⭐ 15,671 | 🐛 418 | 🌐 PHP | 📅 2026-09-23 - A modern flat-file CMS.
* [Magento](https://github.com/magento/magento2) ⭐ 12,199 | 🐛 2,209 | 🌐 PHP | 📅 2026-09-21 - A widely used open-source e-commerce platform.
* [CraftCMS](https://github.com/craftcms/cms) ⭐ 3,608 | 🐛 526 | 🌐 PHP | 📅 2026-09-24 - A flexible, user-friendly CMS for creating custom digital experiences on the web and beyond.
...
* [PHPMailer](https://github.com/PHPMailer/PHPMailer) ⭐ 22,300 | 🐛 24 | 🌐 PHP | 📅 2026-09-20 - Another mailer solution.
* [Mautic](https://github.com/mautic/mautic) ⭐ 10,551 | 🐛 205 | 🌐 PHP | 📅 2026-09-24 - Email marketing automation.
...
* [Intervention Image](https://github.com/Intervention/image) ⭐ 14,371 | 🐛 25 | 🌐 PHP | 📅 2026-09-23 - Another image manipulation library.
...
* [PHPUnit](https://github.com/sebastianbergmann/phpunit) ⭐ 20,054 | 🐛 20 | 🌐 PHP | 📅 2026-09-24 - A unit testing framework.
...
* [ParaTest](https://github.com/paratestphp/paratest) ⭐ 2,508 | 🐛 10 | 🌐 PHP | 📅 2026-09-24 - A parallel testing library for PHPUnit.
* [Infection](https://github.com/infection/infection) ⭐ 2,243 | 🐛 214 | 🌐 PHP | 📅 2026-09-24 - An AST-based PHP Mutation testing framework.
...
* [Setup PHP](https://github.com/shivammathur/setup-php) ⭐ 3,259 | 🐛 9 | 🌐 TypeScript | 📅 2026-09-24 - A GitHub Action for PHP.
...
* [Scramble](https://github.com/dedoc/scramble) ⭐ 2,214 | 🐛 17 | 🌐 PHP | 📅 2026-09-23 - Automatically generates OpenAPI documentation from your code without annotations.
...
* [SQLMap](https://github.com/sqlmapproject/sqlmap) ⭐ 38,507 | 🐛 31 | 🌐 Python | 📅 2026-09-23 - An automatic SQL injection and database takeover tool.
* [Zap](https://github.com/zaproxy/zaproxy) ⭐ 15,821 | 🐛 864 | 🌐 Java | 📅 2026-09-24 - An integrated penetration testing tool for web applications.
...
* [Roave Security Advisories](https://github.com/Roave/SecurityAdvisories) ⭐ 2,917 | 🐛 1 | 📅 2026-09-23 - This package ensures that your application doesn't have installed dependencies with known security vulnerabilities.
...
* [Rector](https://github.com/rectorphp/rector) ⭐ 10,426 | 🐛 3 | 🌐 PHP | 📅 2026-09-24 - A tool to upgrade and refactor code.
* [GrumPHP](https://github.com/phpro/grumphp) ⭐ 4,316 | 🐛 7 | 🌐 PHP | 📅 2026-09-21 - A PHP code-quality tool.
...
* [PHP CS Fixer](https://github.com/PHP-CS-Fixer/PHP-CS-Fixer) ⭐ 13,554 | 🐛 84 | 🌐 PHP | 📅 2026-09-23 - A coding standards fixer library.
...
* [PHPStan](https://github.com/phpstan/phpstan) ⭐ 14,108 | 🐛 1,088 | 🌐 PHP | 📅 2026-09-24 - A PHP Static Analysis Tool.
...
* [Psalm](https://github.com/vimeo/psalm) ⭐ 5,888 | 🐛 2,080 | 🌐 PHP | 📅 2026-09-23 - A static analysis tool for finding errors in PHP applications.
...
* [Dead Code Detector](https://github.com/shipmonk-rnd/dead-code-detector) ⭐ 517 | 🐛 14 | 🌐 PHP | 📅 2026-09-23 - A PHPStan extension for finding unused PHP code.
...
* [Whoops](https://github.com/filp/whoops) ⭐ 13,230 | 🐛 8 | 🌐 PHP | 📅 2026-09-18 - A pretty error-handling library.
...
* [LaraDumps](https://github.com/laradumps/laradumps) ⭐ 1,271 | 🐛 3 | 🌐 PHP | 📅 2026-08-16 - A debugging tool for Laravel with a dedicated desktop application.
...
* [Carbon](https://github.com/briannesbitt/Carbon) ⭐ 16,597 | 🐛 4 | 🌐 PHP | 📅 2026-09-23 - A simple DateTime API extension.
...
* [Swoole](https://github.com/swoole/swoole-src) ⭐ 18,920 | 🐛 60 | 🌐 C++ | 📅 2026-09-24 - An event-driven asynchronous and concurrent networking communication framework with high performance for PHP written in C.
* [Workerman](https://github.com/walkor/Workerman) ⭐ 11,549 | 🐛 109 | 🌐 PHP | 📅 2026-08-29 - An event-driven non-blocking I/O library.
* [ReactPHP](https://github.com/reactphp/reactphp) ⭐ 9,088 | 🐛 0 | 🌐 PHP | 📅 2024-11-25 - An event-driven non-blocking I/O library.
...
* [Shopware](https://github.com/shopware/shopware) ⭐ 3,429 | 🐛 1,433 | 🌐 PHP | 📅 2026-09-24 - Highly customizable e-commerce software.
...
* [Shopsys Framework](https://github.com/shopsys/shopsys/) ⭐ 350 | 🐛 117 | 🌐 PHP | 📅 2026-09-24 - An open source e-commerce platform for in-house development teams.
...
* [Gotenberg](https://github.com/gotenberg/gotenberg-php) ⭐ 398 | 🐛 0 | 🌐 PHP | 📅 2026-08-14 - A PHP client for interacting with Gotenberg.
...
* [PHPWord](https://github.com/PHPOffice/PHPWord) ⭐ 7,590 | 🐛 1,230 | 🌐 PHP | 📅 2026-09-24 - A library for working with Microsoft Word documents.
* [PHPPowerPoint](https://github.com/PHPOffice/PHPPresentation) ⭐ 1,373 | 🐛 233 | 🌐 PHP | 📅 2026-09-24 - A library for working with Microsoft PowerPoint Presentations.
* [OpenSpout](https://github.com/openspout/openspout) ⭐ 1,244 | 🐛 10 | 🌐 PHP | 📅 2026-09-24 - A community driven fork of `box/spout`, a PHP library to read and write spreadsheet files (CSV, XLSX and ODS), in a fast and scalable way.
...
* [PHP AMQP](https://github.com/php-amqplib/php-amqplib) ⭐ 4,602 | 🐛 25 | 🌐 PHP | 📅 2026-09-23 - A pure PHP AMQP library.
...
* [Json Web Token](https://github.com/lcobucci/jwt) ⭐ 7,479 | 🐛 8 | 🌐 PHP | 📅 2026-09-24 - Json Tokens to authenticate and transmit information.
* [TwitterOAuth](https://github.com/abraham/twitteroauth) ⭐ 4,300 | 🐛 10 | 🌐 PHP | 📅 2026-09-22 - A Twitter OAuth library.
* [OAuth 2.0 Client](https://github.com/thephpleague/oauth2-client) ⭐ 3,818 | 🐛 64 | 🌐 PHP | 📅 2026-09-16 - An OAuth 2.0 client library.
...
* [Parsedown](https://github.com/erusev/parsedown) ⭐ 15,059 | 🐛 178 | 🌐 PHP | 📅 2026-02-18 - Another Markdown parser.
* [PHP Markdown](https://github.com/michelf/php-markdown) ⭐ 3,462 | 🐛 98 | 🌐 PHP | 📅 2025-06-17 - A Markdown parser.
* [CommonMark PHP](https://github.com/thephpleague/commonmark) ⭐ 2,978 | 🐛 18 | 🌐 PHP | 📅 2026-09-24 - Highly-extensible Markdown parser which fully supports the [CommonMark spec](https://spec.commonmark.org/).
* [HTML to Markdown](https://github.com/thephpleague/html-to-markdown) ⭐ 1,905 | 🐛 21 | 🌐 PHP | 📅 2026-09-07 - Converts HTML into Markdown.
* [PHP CSS Parser](https://github.com/MyIntervals/PHP-CSS-Parser) ⭐ 1,829 | 🐛 159 | 🌐 PHP | 📅 2026-09-23 - A Parser for CSS Files written in PHP.
...
* [Shiki PHP](https://github.com/spatie/shiki-php) ⭐ 314 | 🐛 0 | 🌐 JavaScript | 📅 2026-04-27 - A [Shiki](https://github.com/shikijs/shiki) ⭐ 13,825 | 🐛 109 | 🌐 TypeScript | 📅 2026-09-11 code highlighting package in PHP.
...
* [UUID](https://github.com/ramsey/uuid) ⭐ 12,629 | 🐛 25 | 🌐 PHP | 📅 2026-09-17 - A library for generating UUIDs.
...
* [Agent](https://github.com/jenssegers/agent) ⭐ 4,871 | 🐛 87 | 🌐 PHP | 📅 2024-08-05 - A PHP desktop/mobile user agent parser, based on Mobiledetect.
* [SQL Formatter](https://github.com/jdorn/sql-formatter/) ⭐ 3,845 | 🐛 36 | 🌐 HTML | 📅 2023-05-26 - A library for formatting SQL statements.
* [Device Detector](https://github.com/matomo-org/device-detector) ⭐ 3,528 | 🐛 76 | 🌐 PHP | 📅 2026-09-23 - Another library for parsing user agent strings.
...
* [Url highlight](https://github.com/vstelmakh/url-highlight) ⭐ 103 | 🐛 1 | 🌐 PHP | 📅 2026-09-23 - A library for parsing URLs from text and converting them into clickable links.
...
* [Respect Validation](https://github.com/Respect/Validation) ⭐ 6,031 | 🐛 14 | 🌐 PHP | 📅 2026-09-24 - A simple validation library.
...
* [Valinor](https://github.com/CuyZ/Valinor) ⭐ 1,530 | 🐛 34 | 🌐 PHP | 📅 2026-09-21 - A library for mapping to strongly typed value objects.
...
* [Jane](https://github.com/janephp/janephp/) ⭐ 691 | 🐛 11 | 🌐 PHP | 📅 2026-09-23 - An OpenApi client generator with validation support.
...
* [OpenAI Client](https://github.com/openai-php/client) ⭐ 5,833 | 🐛 25 | 🌐 PHP | 📅 2026-09-23 - OpenAI PHP is a supercharged community-maintained PHP API client that allows you to interact with OpenAI API.
...
* [Amazon Web Service SDK](https://github.com/aws/aws-sdk-php) ⭐ 6,204 | 🐛 20 | 🌐 PHP | 📅 2026-09-23 - The official PHP AWS SDK library.
* [Stripe](https://github.com/stripe/stripe-php) ⭐ 4,018 | 🐛 13 | 🌐 PHP | 📅 2026-09-23 - The official Stripe PHP library.
...
* [BotMan](https://github.com/botman/botman) ⭐ 6,158 | 🐛 10 | 🌐 PHP | 📅 2026-04-03 - A framework agnostic PHP library to build cross-platform chatbots.
...
* [Static PHP CLI](https://github.com/crazywhalecc/static-php-cli) ⭐ 1,934 | 🐛 38 | 🌐 PHP | 📅 2026-09-24 - Build or [download](https://dl.static-php.dev/static-php-cli/) static versions of PHP CLI and FPM.
...
* [Docker PHP Extension Installer](https://github.com/mlocati/docker-php-extension-installer) ⭐ 4,972 | 🐛 11 | 🌐 Shell | 📅 2026-09-24 - Easily install PHP extensions in Docker containers.
* [Expose](https://github.com/exposedev/expose) ⭐ 4,574 | 🐛 28 | 🌐 PHP | 📅 2026-09-17 - An open-source PHP tunneling service.
* [DDEV](https://github.com/ddev/ddev) ⭐ 3,895 | 🐛 173 | 🌐 Go | 📅 2026-09-24 - A local web development environment system for PHP.
...
* [HHVM](https://github.com/facebook/hhvm) ⭐ 18,666 | 🐛 545 | 🌐 C++ | 📅 2026-09-24 - A Virtual Machine, Runtime and JIT for PHP by Facebook.
* [PeachPie](https://github.com/peachpiecompiler/peachpie) ⭐ 2,486 | 🐛 90 | 🌐 C# | 📅 2026-09-22 - PHP compiler and runtime for .NET and .NET Core.
...
* [Cachet](https://github.com/cachethq/cachet) ⭐ 15,248 | 🐛 6 | 🌐 PHP | 📅 2026-09-21 - The open source status page system.
* [Mailpit](https://github.com/axllent/mailpit) ⭐ 10,430 | 🐛 0 | 🌐 Go | 📅 2026-09-20 - An email and SMTP testing tool for developers.
* [phpMyAdmin](https://github.com/phpmyadmin/phpmyadmin) ⭐ 7,940 | 🐛 927 | 🌐 PHP | 📅 2026-09-23 - A web interface for MySQL/MariaDB.
