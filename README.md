...
Please see [CONTRIBUTING](https://github.com/ziadoz/awesome-php/blob/master/CONTRIBUTING.md) ⭐ 32,680 | 🐛 88 | 📅 2026-07-13, [CODE-OF-CONDUCT](https://github.com/ziadoz/awesome-php/blob/master/CODE-OF-CONDUCT.md) ⭐ 32,680 | 🐛 88 | 📅 2026-07-13 and [COLLABORATING](https://github.com/ziadoz/awesome-php/blob/master/COLLABORATING.md) ⭐ 32,680 | 🐛 88 | 📅 2026-07-13 for details.
...
* [Pie](https://github.com/php/pie) ⭐ 2,009 | 🐛 15 | 🌐 PHP | 📅 2026-09-07 - The official PHP installer for extensions.
...
* [Satis](https://github.com/composer/satis) ⭐ 3,299 | 🐛 98 | 🌐 PHP | 📅 2026-09-04 - A static Composer repository generator.
* [Composer Patches](https://github.com/cweagans/composer-patches) ⭐ 1,725 | 🐛 57 | 🌐 PHP | 📅 2026-08-31 - A plugin for Composer to apply patches.
...
* [Yii2](https://github.com/yiisoft/yii2/) ⭐ 14,295 | 🐛 336 | 🌐 PHP | 📅 2026-09-05 - A fast, secure, and efficient web framework.
* [Tempest](https://github.com/tempestphp/tempest-framework) ⭐ 2,263 | 🐛 31 | 🌐 PHP | 📅 2026-09-08 - A framework that gets out of your way.
...
* [WordPress](https://github.com/WordPress/WordPress) ⭐ 21,397 | 🐛 3 | 🌐 PHP | 📅 2026-09-08 - A blogging platform and CMS.
* [Grav](https://github.com/getgrav/grav) ⭐ 15,662 | 🐛 450 | 🌐 PHP | 📅 2026-09-06 - A modern flat-file CMS.
* [Magento](https://github.com/magento/magento2) ⭐ 12,181 | 🐛 2,175 | 🌐 PHP | 📅 2026-09-08 - A widely used open-source e-commerce platform.
* [CraftCMS](https://github.com/craftcms/cms) ⭐ 3,606 | 🐛 533 | 🌐 PHP | 📅 2026-09-08 - A flexible, user-friendly CMS for creating custom digital experiences on the web and beyond.
* [OpenMage](https://github.com/OpenMage/magento-lts) ⭐ 931 | 🐛 287 | 🌐 PHP | 📅 2026-09-07 - Fork of EoL Magento 1 e-commerce platform.
...
* [Guzzle](https://github.com/guzzle/guzzle) ⭐ 23,458 | 🐛 1 | 🌐 PHP | 📅 2026-09-06 - A comprehensive HTTP client.
* [Requests](https://github.com/WordPress/Requests) ⭐ 3,574 | 🐛 126 | 🌐 PHP | 📅 2026-09-02 - A simple HTTP library.
* [Saloon](https://github.com/saloonphp/saloon) ⭐ 2,439 | 🐛 28 | 🌐 PHP | 📅 2026-09-04 - A framework for building beautiful API integrations and SDKs.
* [Symfony HTTP Client](https://github.com/symfony/http-client) ⭐ 2,028 | 🐛 0 | 🌐 PHP | 📅 2026-08-30 - A component to fetch HTTP resources synchronously or asynchronously.
...
* [Laminas Stratigility](https://github.com/laminas/laminas-stratigility) ⭐ 58 | 🐛 3 | 🌐 PHP | 📅 2026-09-07 - Middleware for PHP built on top of PSR-7.
...
* [PHPMailer](https://github.com/PHPMailer/PHPMailer) ⭐ 22,291 | 🐛 30 | 🌐 PHP | 📅 2026-09-06 - Another mailer solution.
* [Mautic](https://github.com/mautic/mautic) ⭐ 10,454 | 🐛 193 | 🌐 PHP | 📅 2026-09-07 - Email marketing automation.
...
* [PHPUnit](https://github.com/sebastianbergmann/phpunit) ⭐ 20,051 | 🐛 23 | 🌐 PHP | 📅 2026-09-08 - A unit testing framework.
* [Mockery](https://github.com/mockery/mockery) ⭐ 10,724 | 🐛 95 | 🌐 PHP | 📅 2026-09-06 - A mock object library for testing.
...
* [ParaTest](https://github.com/paratestphp/paratest) ⭐ 2,500 | 🐛 6 | 🌐 PHP | 📅 2026-09-04 - A parallel testing library for PHPUnit.
* [Infection](https://github.com/infection/infection) ⭐ 2,239 | 🐛 213 | 🌐 PHP | 📅 2026-09-08 - An AST-based PHP Mutation testing framework.
...
* [Foundry](https://github.com/zenstruck/foundry) ⭐ 800 | 🐛 27 | 🌐 PHP | 📅 2026-09-07 - A fixture factory generation library for Doctrine.
...
* [Setup PHP](https://github.com/shivammathur/setup-php) ⭐ 3,254 | 🐛 6 | 🌐 TypeScript | 📅 2026-09-07 - A GitHub Action for PHP.
...
* [zircote/swagger-php](https://github.com/zircote/swagger-php) ⭐ 5,309 | 🐛 15 | 🌐 PHP | 📅 2026-09-08 - Generate OpenAPI documentation for your RESTful API.
* [Scramble](https://github.com/dedoc/scramble) ⭐ 2,200 | 🐛 15 | 🌐 PHP | 📅 2026-09-08 - Automatically generates OpenAPI documentation from your code without annotations.
...
* [SQLMap](https://github.com/sqlmapproject/sqlmap) ⭐ 38,386 | 🐛 33 | 🌐 Python | 📅 2026-09-07 - An automatic SQL injection and database takeover tool.
* [Zap](https://github.com/zaproxy/zaproxy) ⭐ 15,745 | 🐛 860 | 🌐 Java | 📅 2026-09-08 - An integrated penetration testing tool for web applications.
* [Halite](https://paragonie.com/project/halite) - A simple library for encryption using [libsodium](https://github.com/jedisct1/libsodium) ⭐ 13,940 | 🐛 1 | 🌐 C | 📅 2026-09-06.
* [PHPSecLib](https://github.com/phpseclib/phpseclib) ⭐ 5,585 | 🐛 209 | 🌐 PHP | 📅 2026-09-06 - A pure PHP secure communications library.
* [PHPGGC](https://github.com/ambionics/phpggc) ⭐ 3,882 | 🐛 22 | 🌐 PHP | 📅 2025-09-29 - A library of PHP unserializable payloads along with a tool to generate them.
* [PHP Encryption](https://github.com/defuse/php-encryption) ⭐ 3,876 | 🐛 11 | 🌐 PHP | 📅 2024-01-02 - Secure PHP Encryption Library.
* [Roave Security Advisories](https://github.com/Roave/SecurityAdvisories) ⭐ 2,913 | 🐛 1 | 📅 2026-09-02 - This package ensures that your application doesn't have installed dependencies with known security vulnerabilities.
...
* [AntiXSS](https://github.com/voku/anti-xss) ⭐ 713 | 🐛 3 | 🌐 PHP | 📅 2026-09-08 - A library that tries to preventing Cross-Site Scripting (XSS) attacks by blacklisting.
...
* [Rector](https://github.com/rectorphp/rector) ⭐ 10,417 | 🐛 2 | 🌐 PHP | 📅 2026-09-07 - A tool to upgrade and refactor code.
* [GrumPHP](https://github.com/phpro/grumphp) ⭐ 4,313 | 🐛 6 | 🌐 PHP | 📅 2026-08-11 - A PHP code-quality tool.
* [Phpactor](https://github.com/phpactor/phpactor) ⭐ 1,924 | 🐛 292 | 🌐 PHP | 📅 2026-08-26 - PHP completion, refactoring and introspection tool.
...
* [Editorconfig-Checker](https://github.com/editorconfig-checker/editorconfig-checker.php) ⭐ 76 | 🐛 7 | 🌐 PHP | 📅 2026-09-07 - A command line utility which verifies that your files implement your `.editorconfig` rules.
...
* [PHP CS Fixer](https://github.com/PHP-CS-Fixer/PHP-CS-Fixer) ⭐ 13,549 | 🐛 83 | 🌐 PHP | 📅 2026-09-07 - A coding standards fixer library.
* [Laravel Pint](https://github.com/laravel/pint) ⭐ 3,162 | 🐛 8 | 🌐 PHP | 📅 2026-09-07 - A coding standards fixer library for Laravel.
* [PHP Mess Detector](https://github.com/phpmd/phpmd) ⭐ 2,452 | 🐛 59 | 🌐 PHP | 📅 2026-09-08 - A library that scans code for bugs, sub-optimal code, unused parameters and more.
* [PHP CodeSniffer](https://github.com/PHPCSStandards/PHP_CodeSniffer) ⭐ 1,553 | 🐛 204 | 🌐 PHP | 📅 2026-09-05 - A library that detects and can auto-fix PHP, CSS and JS coding standard violations.
...
* [PHPStan](https://github.com/phpstan/phpstan) ⭐ 14,100 | 🐛 1,133 | 🌐 PHP | 📅 2026-09-07 - A PHP Static Analysis Tool.
* [Larastan](https://github.com/larastan/larastan) ⭐ 6,499 | 🐛 111 | 🌐 PHP | 📅 2026-09-07 - A PHPStan wrapper for Laravel that adds static analysis to Laravel projects.
* [Psalm](https://github.com/vimeo/psalm) ⭐ 5,889 | 🐛 2,104 | 🌐 PHP | 📅 2026-07-13 - A static analysis tool for finding errors in PHP applications.
* [phan](https://github.com/phan/phan) ⭐ 5,623 | 🐛 794 | 🌐 PHP | 📅 2026-09-05 - A static analyzer based on PHP 7+ and the php-ast extension.
* [Mago](https://github.com/carthage-software/mago) ⭐ 3,428 | 🐛 97 | 🌐 Rust | 📅 2026-09-08 - A toolchain for PHP that aims to improve the developer experience.
* [Deptrac](https://github.com/deptrac/deptrac) ⭐ 3,011 | 🐛 37 | 🌐 PHP | 📅 2026-08-14 - A static analysis tool for enforcing dependency rules between architectural layers.
...
* [Dead Code Detector](https://github.com/shipmonk-rnd/dead-code-detector) ⭐ 510 | 🐛 12 | 🌐 PHP | 📅 2026-08-31 - A PHPStan extension for finding unused PHP code.
...
* [xDebug](https://github.com/xdebug/xdebug) ⭐ 3,416 | 🐛 10 | 🌐 PHP | 📅 2026-09-02 - A debug and profile tool for PHP.
...
* [PHPSpy](https://github.com/adsr/phpspy) ⭐ 1,500 | 🐛 21 | 🌐 C | 📅 2026-09-07 - A low-overhead sampling profiler.
...
* [PCOV](https://github.com/krakjoe/pcov) ⭐ 790 | 🐛 36 | 🌐 C | 📅 2026-07-21 - A self-contained code coverage compatible driver.
...
* [Trap](https://github.com/buggregator/trap) ⭐ 275 | 🐛 35 | 🌐 PHP | 📅 2026-09-08 - An extended variable dumper with a web interface and IDE plugin.
...
* [Symfony Encore](https://github.com/symfony/webpack-encore) ⭐ 2,221 | 🐛 2 | 🌐 JavaScript | 📅 2026-09-07 - A simple but powerful API for processing and compiling assets built around Webpack.
...
* [Yasumi](https://github.com/azuyalabs/yasumi) ⭐ 1,100 | 🐛 9 | 🌐 PHP | 📅 2026-08-30 - A library to help you calculate the dates and names of holidays.
...
* [Swoole](https://github.com/swoole/swoole-src) ⭐ 18,915 | 🐛 48 | 🌐 C++ | 📅 2026-09-08 - An event-driven asynchronous and concurrent networking communication framework with high performance for PHP written in C.
...
* [Monolog](https://github.com/Seldaek/monolog) ⭐ 21,404 | 🐛 8 | 🌐 PHP | 📅 2026-09-02 - A comprehensive logger.
...
* [Shopware](https://github.com/shopware/shopware) ⭐ 3,420 | 🐛 1,316 | 🌐 PHP | 📅 2026-09-08 - Highly customizable e-commerce software.
* [Brick Money](https://github.com/brick/money) ⭐ 1,926 | 🐛 5 | 🌐 PHP | 📅 2026-09-05 - A money library for PHP, with support for contexts, cash roundings, currency conversion.
...
* [Shopsys Framework](https://github.com/shopsys/shopsys/) ⭐ 349 | 🐛 117 | 🌐 PHP | 📅 2026-09-08 - An open source e-commerce platform for in-house development teams.
...
* [PHPSpreadsheet](https://github.com/PHPOffice/PhpSpreadsheet) ⭐ 13,985 | 🐛 101 | 🌐 PHP | 📅 2026-09-04 - A pure PHP library for reading and writing spreadsheet files (successor of PHPExcel).
* [PHPWord](https://github.com/PHPOffice/PHPWord) ⭐ 7,586 | 🐛 1,234 | 🌐 PHP | 📅 2026-09-08 - A library for working with Microsoft Word documents.
* [PHPPowerPoint](https://github.com/PHPOffice/PHPPresentation) ⭐ 1,373 | 🐛 256 | 🌐 PHP | 📅 2026-09-08 - A library for working with Microsoft PowerPoint Presentations.
* [OpenSpout](https://github.com/openspout/openspout) ⭐ 1,231 | 🐛 10 | 🌐 PHP | 📅 2026-09-07 - A community driven fork of `box/spout`, a PHP library to read and write spreadsheet files (CSV, XLSX and ODS), in a fast and scalable way.

### Database

*Libraries for interacting with databases using object-relational mapping (ORM) or datamapping techniques.*

* [ProxyManager](https://github.com/Ocramius/ProxyManager) ⭐ 4,943 | 🐛 55 | 🌐 PHP | 📅 2026-09-08 - A set of utilities to generate proxy objects for data mappers.
...
* [Laravel Eloquent](https://github.com/illuminate/database) ⭐ 2,773 | 🐛 7 | 🌐 PHP | 📅 2026-09-08 - A simple ORM.
...
* [Aura.SqlQuery](https://github.com/auraphp/Aura.SqlQuery) ⭐ 456 | 🐛 4 | 🌐 PHP | 📅 2026-09-08 - Independent query builders for MySQL, PostgreSQL, SQLite, and Microsoft SQL Server.
...
* [MongoDB PHP Library](https://github.com/mongodb/mongo-php-library) ⭐ 1,612 | 🐛 2 | 🌐 PHP | 📅 2026-09-07 - The official high-level MongoDB PHP library built on top of the MongoDB PHP Driver.
...
* [PsySH](https://github.com/bobthecow/psysh) ⭐ 9,831 | 🐛 9 | 🌐 PHP | 📅 2026-09-08 - Another PHP REPL.
...
* [Json Web Token](https://github.com/lcobucci/jwt) ⭐ 7,480 | 🐛 9 | 🌐 PHP | 📅 2026-09-04 - Json Tokens to authenticate and transmit information.
...
* [Parsedown](https://github.com/erusev/parsedown) ⭐ 15,058 | 🐛 180 | 🌐 PHP | 📅 2026-02-18 - Another Markdown parser.
* [PHP Markdown](https://github.com/michelf/php-markdown) ⭐ 3,462 | 🐛 98 | 🌐 PHP | 📅 2025-06-17 - A Markdown parser.
* [CommonMark PHP](https://github.com/thephpleague/commonmark) ⭐ 2,976 | 🐛 20 | 🌐 PHP | 📅 2026-09-08 - Highly-extensible Markdown parser which fully supports the [CommonMark spec](https://spec.commonmark.org/).
* [HTML to Markdown](https://github.com/thephpleague/html-to-markdown) ⭐ 1,906 | 🐛 21 | 🌐 PHP | 📅 2026-09-07 - Converts HTML into Markdown.
* [PHP CSS Parser](https://github.com/MyIntervals/PHP-CSS-Parser) ⭐ 1,827 | 🐛 159 | 🌐 PHP | 📅 2026-09-06 - A Parser for CSS Files written in PHP.
...
* [Shiki PHP](https://github.com/spatie/shiki-php) ⭐ 312 | 🐛 0 | 🌐 JavaScript | 📅 2026-04-27 - A [Shiki](https://github.com/shikijs/shiki) ⭐ 13,783 | 🐛 115 | 🌐 TypeScript | 📅 2026-08-10 code highlighting package in PHP.
...
* [Device Detector](https://github.com/matomo-org/device-detector) ⭐ 3,526 | 🐛 80 | 🌐 PHP | 📅 2026-09-06 - Another library for parsing user agent strings.
...
* [Hyphenation](https://github.com/heiglandreas/Org_Heigl_Hyphenator) ⭐ 54 | 🐛 7 | 🌐 PHP | 📅 2026-08-01 - Text hyphenation based on the TeX hyphenation algorithm.
...
* [Brick Math](https://github.com/brick/math) ⭐ 2,162 | 🐛 0 | 🌐 PHP | 📅 2026-08-31 - A library providing large number support: `BigInteger`, `BigDecimal` and `BigRational`.
...
* [Respect Validation](https://github.com/Respect/Validation) ⭐ 6,029 | 🐛 12 | 🌐 PHP | 📅 2026-09-08 - A simple validation library.
* [LibPhoneNumber for PHP](https://github.com/giggsey/libphonenumber-for-php) ⭐ 5,052 | 🐛 2 | 🌐 PHP | 📅 2026-09-01 - A PHP implementation of Google's phone number handling library.
...
* [HTML Purifier](https://github.com/ezyang/htmlpurifier) ⭐ 3,353 | 🐛 134 | 🌐 PHP | 📅 2026-09-05 - A standards compliant HTML filter.
...
* [Valinor](https://github.com/CuyZ/Valinor) ⭐ 1,529 | 🐛 31 | 🌐 PHP | 📅 2026-09-07 - A library for mapping to strongly typed value objects.
...
* [Aura.Filter](https://github.com/auraphp/Aura.Filter) ⭐ 157 | 🐛 4 | 🌐 PHP | 📅 2026-09-08 - Provides tools to validate and sanitize objects and arrays.
...
* [Jane](https://github.com/janephp/janephp/) ⭐ 690 | 🐛 13 | 🌐 PHP | 📅 2026-09-08 - An OpenApi client generator with validation support.
...
* [Laminas Serializer](https://github.com/laminas/laminas-serializer) ⭐ 36 | 🐛 6 | 🌐 PHP | 📅 2026-09-07 - Another library for serialising and de-serialising data.

### Notifications

*Libraries for working with notification software.*

* [JoliNotif](https://github.com/jolicode/JoliNotif) ⭐ 1,441 | 🐛 1 | 🌐 PHP | 📅 2026-09-01 - A cross-platform library for desktop notification (support for Growl, notify-send, toaster, etc).
...
* [PHP Dotenv](https://github.com/vlucas/phpdotenv) ⭐ 13,551 | 🐛 2 | 🌐 PHP | 📅 2026-08-24 - Parse and load environment variables from `.env` files.
...
* [Amazon Web Service SDK](https://github.com/aws/aws-sdk-php) ⭐ 6,204 | 🐛 21 | 🌐 PHP | 📅 2026-09-04 - The official PHP AWS SDK library.
* [Stripe](https://github.com/stripe/stripe-php) ⭐ 4,019 | 🐛 14 | 🌐 PHP | 📅 2026-09-08 - The official Stripe PHP library.
...
* [Zephir](https://github.com/zephir-lang/zephir) ⭐ 3,386 | 🐛 49 | 🌐 PHP | 📅 2026-09-08 - A compiled language between PHP and C++ for developing PHP extensions.
...
* [Static PHP CLI](https://github.com/crazywhalecc/static-php-cli) ⭐ 1,932 | 🐛 38 | 🌐 PHP | 📅 2026-08-22 - Build or [download](https://dl.static-php.dev/static-php-cli/) static versions of PHP CLI and FPM.
...
* [Docker PHP Extension Installer](https://github.com/mlocati/docker-php-extension-installer) ⭐ 4,965 | 🐛 14 | 🌐 Shell | 📅 2026-09-07 - Easily install PHP extensions in Docker containers.
* [Expose](https://github.com/exposedev/expose) ⭐ 4,571 | 🐛 28 | 🌐 PHP | 📅 2026-07-09 - An open-source PHP tunneling service.
* [DDEV](https://github.com/ddev/ddev) ⭐ 3,832 | 🐛 168 | 🌐 Go | 📅 2026-09-08 - A local web development environment system for PHP.
* [Takeout](https://github.com/tighten/takeout) ⭐ 1,655 | 🐛 6 | 🌐 PHP | 📅 2026-04-09 - A Docker-based development-only dependency manager.
* [Solo](https://github.com/soloterm/solo) ⭐ 1,289 | 🐛 27 | 🌐 PHP | 📅 2026-03-17 - A terminal application to manage processes for a Laravel application.
...
* [HHVM](https://github.com/facebook/hhvm) ⭐ 18,661 | 🐛 546 | 🌐 C++ | 📅 2026-09-04 - A Virtual Machine, Runtime and JIT for PHP by Facebook.
...
* [Mailpit](https://github.com/axllent/mailpit) ⭐ 10,313 | 🐛 1 | 🌐 Go | 📅 2026-09-06 - An email and SMTP testing tool for developers.
* [phpMyAdmin](https://github.com/phpmyadmin/phpmyadmin) ⭐ 7,929 | 🐛 934 | 🌐 PHP | 📅 2026-09-08 - A web interface for MySQL/MariaDB.
...
* [RoadRunner](https://github.com/roadrunner-server/roadrunner) ⭐ 8,505 | 🐛 49 | 🌐 Go | 📅 2026-09-03 - High-performance PHP application server, load-balancer and process manager.
