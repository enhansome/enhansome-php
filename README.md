...
Please see [CONTRIBUTING](https://github.com/ziadoz/awesome-php/blob/master/CONTRIBUTING.md) ⭐ 32,696 | 🐛 90 | 📅 2026-07-13, [CODE-OF-CONDUCT](https://github.com/ziadoz/awesome-php/blob/master/CODE-OF-CONDUCT.md) ⭐ 32,696 | 🐛 90 | 📅 2026-07-13 and [COLLABORATING](https://github.com/ziadoz/awesome-php/blob/master/COLLABORATING.md) ⭐ 32,696 | 🐛 90 | 📅 2026-07-13 for details.
...
* [Pie](https://github.com/php/pie) ⭐ 2,014 | 🐛 14 | 🌐 PHP | 📅 2026-09-10 - The official PHP installer for extensions.
...
* [Satis](https://github.com/composer/satis) ⭐ 3,302 | 🐛 98 | 🌐 PHP | 📅 2026-09-10 - A static Composer repository generator.
* [Composer Patches](https://github.com/cweagans/composer-patches) ⭐ 1,727 | 🐛 57 | 🌐 PHP | 📅 2026-08-31 - A plugin for Composer to apply patches.
* [Composer Unused](https://github.com/composer-unused/composer-unused) ⭐ 1,690 | 🐛 15 | 🌐 PHP | 📅 2026-09-04 - A CLI Tool to scan for unused composer packages.
* [Composer Normalize](https://github.com/ergebnis/composer-normalize) ⭐ 1,123 | 🐛 8 | 🌐 PHP | 📅 2026-09-09 - A plugin for normalizing `composer.json` files.
...
* [Composer Require Checker](https://github.com/maglnet/ComposerRequireChecker) ⭐ 1,011 | 🐛 45 | 🌐 PHP | 📅 2026-09-13 - CLI tool to analyze composer dependencies and verify that no unknown symbols are used in the sources of a package.
...
* [Yii2](https://github.com/yiisoft/yii2/) ⭐ 14,292 | 🐛 335 | 🌐 PHP | 📅 2026-09-10 - A fast, secure, and efficient web framework.
* [Tempest](https://github.com/tempestphp/tempest-framework) ⭐ 2,266 | 🐛 27 | 🌐 PHP | 📅 2026-09-09 - A framework that gets out of your way.
...
* [WordPress](https://github.com/WordPress/WordPress) ⭐ 21,416 | 🐛 3 | 🌐 PHP | 📅 2026-09-12 - A blogging platform and CMS.
* [Grav](https://github.com/getgrav/grav) ⭐ 15,663 | 🐛 440 | 🌐 PHP | 📅 2026-09-11 - A modern flat-file CMS.
* [Magento](https://github.com/magento/magento2) ⭐ 12,186 | 🐛 2,180 | 🌐 PHP | 📅 2026-09-10 - A widely used open-source e-commerce platform.
* [CraftCMS](https://github.com/craftcms/cms) ⭐ 3,608 | 🐛 534 | 🌐 PHP | 📅 2026-09-12 - A flexible, user-friendly CMS for creating custom digital experiences on the web and beyond.
* [OpenMage](https://github.com/OpenMage/magento-lts) ⭐ 932 | 🐛 285 | 🌐 PHP | 📅 2026-09-11 - Fork of EoL Magento 1 e-commerce platform.
...
* [Silly](https://github.com/mnapoli/silly) ⭐ 932 | 🐛 4 | 🌐 PHP | 📅 2026-06-29 - A micro-framework for CLI applications.
...
* [Fast Route](https://github.com/nikic/FastRoute) ⭐ 5,268 | 🐛 27 | 🌐 PHP | 📅 2026-07-09 - A fast routing library.
* [Klein](https://github.com/klein/klein.php) ⭐ 2,655 | 🐛 95 | 🌐 PHP | 📅 2024-01-30 - A flexible router.
...
* [Mustache](https://github.com/bobthecow/mustache.php) ⭐ 3,285 | 🐛 4 | 🌐 PHP | 📅 2026-07-28 - A PHP implementation of the Mustache template language.
...
* [Guzzle](https://github.com/guzzle/guzzle) ⭐ 23,454 | 🐛 1 | 🌐 PHP | 📅 2026-09-06 - A comprehensive HTTP client.
* [Requests](https://github.com/WordPress/Requests) ⭐ 3,575 | 🐛 125 | 🌐 PHP | 📅 2026-09-02 - A simple HTTP library.
* [Saloon](https://github.com/saloonphp/saloon) ⭐ 2,440 | 🐛 28 | 🌐 PHP | 📅 2026-09-04 - A framework for building beautiful API integrations and SDKs.
* [Symfony HTTP Client](https://github.com/symfony/http-client) ⭐ 2,029 | 🐛 0 | 🌐 PHP | 📅 2026-09-10 - A component to fetch HTTP resources synchronously or asynchronously.
* [Buzz](https://github.com/kriswallsmith/Buzz) ⭐ 1,916 | 🐛 9 | 🌐 PHP | 📅 2026-05-15 - Another HTTP client.
* [Nyholm PSR-7](https://github.com/Nyholm/psr7) ⭐ 1,278 | 🐛 5 | 🌐 PHP | 📅 2025-11-28 - A super lightweight PSR-7 implementation. Very strict and very fast.
* [Laminas Diactoros](https://github.com/laminas/laminas-diactoros) ⭐ 560 | 🐛 34 | 🌐 PHP | 📅 2026-09-07 - PSR-7 HTTP Message implementation.
...
* [Symfony Panther](https://github.com/symfony/panther) ⭐ 3,070 | 🐛 210 | 🌐 PHP | 📅 2026-06-04 - A browser testing and web crawling library for PHP and Symfony.
* [Chrome PHP](https://github.com/chrome-php/chrome) ⭐ 2,677 | 🐛 1 | 🌐 PHP | 📅 2026-07-06 - Instrument headless Chrome/Chromium instances from PHP.
* [CrawlerDetect](https://github.com/JayBizzle/Crawler-Detect) ⭐ 2,405 | 🐛 2 | 🌐 PHP | 📅 2026-09-06 - A PHP class for detecting bots/crawlers/spiders via the user agent.
* [DiDOM](https://github.com/Imangazaliev/DiDOM) ⭐ 2,197 | 🐛 27 | 🌐 PHP | 📅 2026-01-28 - A super-fast HTML scrapper and parser.
...
* [PSR-15 Middlewares](https://github.com/middlewares/psr15-middlewares) ⭐ 411 | 🐛 0 | 📅 2025-04-05 - Inspiring collection of handy middlewares.
* [Laminas Stratigility](https://github.com/laminas/laminas-stratigility) ⭐ 58 | 🐛 3 | 🌐 PHP | 📅 2026-09-08 - Middleware for PHP built on top of PSR-7.
...
* [PHP Domain Parser](https://github.com/jeremykendall/php-domain-parser) ⭐ 1,241 | 🐛 0 | 🌐 PHP | 📅 2026-01-30 - A domain suffix parser library.
* [Uri](https://github.com/thephpleague/uri) ⭐ 1,128 | 🐛 0 | 🌐 PHP | 📅 2026-09-12 - Another URL manipulation library.
* [sabre/uri](https://github.com/sabre-io/uri) ⭐ 297 | 🐛 6 | 🌐 PHP | 📅 2026-09-04 - A functional URI manipulation library.

### Email

*Libraries for sending and parsing email.*

* [PHPMailer](https://github.com/PHPMailer/PHPMailer) ⭐ 22,300 | 🐛 24 | 🌐 PHP | 📅 2026-09-10 - Another mailer solution.
* [Mautic](https://github.com/mautic/mautic) ⭐ 10,496 | 🐛 184 | 🌐 PHP | 📅 2026-09-12 - Email marketing automation.
...
* [Symfony Mailer](https://github.com/symfony/mailer) ⭐ 1,594 | 🐛 0 | 🌐 PHP | 📅 2026-09-10 - A powerful library for creating and sending emails.
...
* [PHP FFmpeg](https://github.com/PHP-FFmpeg/PHP-FFmpeg/) ⭐ 5,017 | 🐛 328 | 🌐 PHP | 📅 2026-01-19 - A wrapper for the [FFmpeg](https://www.ffmpeg.org/) video library.
* [CSV](https://github.com/thephpleague/csv) ⭐ 3,482 | 🐛 2 | 🌐 PHP | 📅 2026-09-06 - A CSV data manipulation library.
...
* [Parquet](https://github.com/flow-php/parquet) ⭐ 61 | 🐛 0 | 🌐 PHP | 📅 2026-09-12 - PHP implementation of Parquet file format.
...
* [Symfony DI](https://github.com/symfony/dependency-injection) ⭐ 4,166 | 🐛 0 | 🌐 PHP | 📅 2026-09-11 - A dependency injection container component.
...
* [Intervention Image](https://github.com/Intervention/image) ⭐ 14,371 | 🐛 22 | 🌐 PHP | 📅 2026-08-29 - Another image manipulation library.
* [Glide](https://github.com/thephpleague/glide) ⭐ 2,633 | 🐛 37 | 🌐 PHP | 📅 2026-07-16 - An on-demand image manipulation library.
* [PHP QR Code](https://github.com/chillerlan/php-qrcode/) ⭐ 2,386 | 🐛 2 | 🌐 PHP | 📅 2026-08-31 - QR Code generator and reader.
...
* [PHPUnit](https://github.com/sebastianbergmann/phpunit) ⭐ 20,053 | 🐛 24 | 🌐 PHP | 📅 2026-09-13 - A unit testing framework.
...
* [Codeception](https://github.com/Codeception/Codeception) ⭐ 4,858 | 🐛 167 | 🌐 PHP | 📅 2026-08-07 - A full stack testing framework.
* [Faker](https://github.com/fakerphp/faker) ⭐ 3,992 | 🐛 37 | 🌐 PHP | 📅 2026-05-02 - A fake data generator library.
* [Alice](https://github.com/nelmio/alice) ⭐ 2,538 | 🐛 52 | 🌐 PHP | 📅 2026-06-15 - An expressive fixture generation library.
* [ParaTest](https://github.com/paratestphp/paratest) ⭐ 2,506 | 🐛 6 | 🌐 PHP | 📅 2026-09-13 - A parallel testing library for PHPUnit.
* [Infection](https://github.com/infection/infection) ⭐ 2,242 | 🐛 215 | 🌐 PHP | 📅 2026-09-11 - An AST-based PHP Mutation testing framework.
* [PHPSpec](https://github.com/phpspec/phpspec) ⭐ 1,902 | 🐛 137 | 🌐 PHP | 📅 2026-08-08 - A design by specification unit testing library.
...
* [Foundry](https://github.com/zenstruck/foundry) ⭐ 800 | 🐛 29 | 🌐 PHP | 📅 2026-09-07 - A fixture factory generation library for Doctrine.
* [PHP MySQL Engine](https://github.com/vimeo/php-mysql-engine) ⭐ 563 | 🐛 10 | 🌐 PHP | 📅 2026-07-17 - A MySQL engine written in pure PHP.
* [Nette Tester](https://github.com/nette/tester) ⭐ 489 | 🐛 20 | 🌐 PHP | 📅 2026-09-13 - A productive and enjoyable parallel unit testing framework.
...
* [Setup PHP](https://github.com/shivammathur/setup-php) ⭐ 3,256 | 🐛 9 | 🌐 TypeScript | 📅 2026-09-11 - A GitHub Action for PHP.
...
* [zircote/swagger-php](https://github.com/zircote/swagger-php) ⭐ 5,309 | 🐛 23 | 🌐 PHP | 📅 2026-09-12 - Generate OpenAPI documentation for your RESTful API.
* [Scramble](https://github.com/dedoc/scramble) ⭐ 2,204 | 🐛 15 | 🌐 PHP | 📅 2026-09-08 - Automatically generates OpenAPI documentation from your code without annotations.
* [APIGen](https://github.com/apigen/apigen) ⭐ 2,167 | 🐛 24 | 🌐 PHP | 📅 2025-02-21 - Another API documentation generator.
* [daux.io](https://github.com/dauxio/daux.io) ⭐ 829 | 🐛 7 | 🌐 PHP | 📅 2026-09-12 - A documentation generator that uses Markdown files.
...
* [SQLMap](https://github.com/sqlmapproject/sqlmap) ⭐ 38,429 | 🐛 32 | 🌐 Python | 📅 2026-09-08 - An automatic SQL injection and database takeover tool.
* [Zap](https://github.com/zaproxy/zaproxy) ⭐ 15,765 | 🐛 862 | 🌐 Java | 📅 2026-09-10 - An integrated penetration testing tool for web applications.
* [Halite](https://paragonie.com/project/halite) - A simple library for encryption using [libsodium](https://github.com/jedisct1/libsodium) ⭐ 13,950 | 🐛 1 | 🌐 C | 📅 2026-09-09.
* [PHPSecLib](https://github.com/phpseclib/phpseclib) ⭐ 5,585 | 🐛 209 | 🌐 PHP | 📅 2026-09-06 - A pure PHP secure communications library.
* [PHPGGC](https://github.com/ambionics/phpggc) ⭐ 3,887 | 🐛 22 | 🌐 PHP | 📅 2025-09-29 - A library of PHP unserializable payloads along with a tool to generate them.
* [PHP Encryption](https://github.com/defuse/php-encryption) ⭐ 3,877 | 🐛 11 | 🌐 PHP | 📅 2024-01-02 - Secure PHP Encryption Library.
* [Roave Security Advisories](https://github.com/Roave/SecurityAdvisories) ⭐ 2,914 | 🐛 1 | 📅 2026-09-11 - This package ensures that your application doesn't have installed dependencies with known security vulnerabilities.
...
* [AntiXSS](https://github.com/voku/anti-xss) ⭐ 713 | 🐛 3 | 🌐 PHP | 📅 2026-09-09 - A library that tries to preventing Cross-Site Scripting (XSS) attacks by blacklisting.
...
* [Rector](https://github.com/rectorphp/rector) ⭐ 10,420 | 🐛 4 | 🌐 PHP | 📅 2026-09-13 - A tool to upgrade and refactor code.
* [GrumPHP](https://github.com/phpro/grumphp) ⭐ 4,314 | 🐛 7 | 🌐 PHP | 📅 2026-09-08 - A PHP code-quality tool.
* [Phpactor](https://github.com/phpactor/phpactor) ⭐ 1,926 | 🐛 292 | 🌐 PHP | 📅 2026-08-26 - PHP completion, refactoring and introspection tool.
* [Better Reflection](https://github.com/Roave/BetterReflection) ⭐ 1,247 | 🐛 19 | 🌐 PHP | 📅 2026-09-12 - An AST-based reflection library that allows analysis and manipulation of code.
...
* [PHP Semantic Versioning Checker](https://github.com/tomzx/php-semver-checker) ⭐ 437 | 🐛 39 | 🌐 PHP | 📅 2026-09-13 - A command line utility that compares two source sets and determines the appropriate semantic versioning to apply.
* [Bladestan](https://github.com/bladestan/bladestan) ⭐ 375 | 🐛 23 | 🌐 PHP | 📅 2026-09-02 - A PHPStan extension for static analysis of Blade templates.
...
* [PHP CS Fixer](https://github.com/PHP-CS-Fixer/PHP-CS-Fixer) ⭐ 13,551 | 🐛 87 | 🌐 PHP | 📅 2026-09-11 - A coding standards fixer library.
* [Laravel Pint](https://github.com/laravel/pint) ⭐ 3,165 | 🐛 9 | 🌐 PHP | 📅 2026-09-10 - A coding standards fixer library for Laravel.
* [PHP Mess Detector](https://github.com/phpmd/phpmd) ⭐ 2,453 | 🐛 60 | 🌐 PHP | 📅 2026-09-13 - A library that scans code for bugs, sub-optimal code, unused parameters and more.
* [PHP CodeSniffer](https://github.com/PHPCSStandards/PHP_CodeSniffer) ⭐ 1,556 | 🐛 204 | 🌐 PHP | 📅 2026-09-11 - A library that detects and can auto-fix PHP, CSS and JS coding standard violations.
* [CaptainHook](https://github.com/captainhook-git/captainhook) ⭐ 1,120 | 🐛 12 | 🌐 PHP | 📅 2026-03-25 - An easy-to-use and flexible Git hook library.
...
* [PHPStan](https://github.com/phpstan/phpstan) ⭐ 14,101 | 🐛 1,087 | 🌐 PHP | 📅 2026-09-12 - A PHP Static Analysis Tool.
* [Larastan](https://github.com/larastan/larastan) ⭐ 6,501 | 🐛 107 | 🌐 PHP | 📅 2026-09-11 - A PHPStan wrapper for Laravel that adds static analysis to Laravel projects.
* [Psalm](https://github.com/vimeo/psalm) ⭐ 5,891 | 🐛 2,082 | 🌐 PHP | 📅 2026-09-12 - A static analysis tool for finding errors in PHP applications.
* [phan](https://github.com/phan/phan) ⭐ 5,624 | 🐛 794 | 🌐 PHP | 📅 2026-09-05 - A static analyzer based on PHP 7+ and the php-ast extension.
* [Mago](https://github.com/carthage-software/mago) ⭐ 3,445 | 🐛 102 | 🌐 Rust | 📅 2026-09-11 - A toolchain for PHP that aims to improve the developer experience.
* [Deptrac](https://github.com/deptrac/deptrac) ⭐ 3,014 | 🐛 37 | 🌐 PHP | 📅 2026-08-14 - A static analysis tool for enforcing dependency rules between architectural layers.
* [PHP Metrics](https://github.com/phpmetrics/PhpMetrics) ⭐ 2,612 | 🐛 3 | 🌐 PHP | 📅 2026-08-21 - A static metric library.
* [PHPCompatibility](https://github.com/PHPCompatibility/PHPCompatibility) ⭐ 2,302 | 🐛 97 | 🌐 PHP | 📅 2026-09-12 - A PHP compatibility checker for PHP CodeSniffer.
* [PHPDoc Parser](https://github.com/phpstan/phpdoc-parser) ⭐ 1,534 | 🐛 24 | 🌐 PHP | 📅 2026-09-13 - Next-gen phpDoc parser with support for intersection types and generics.
...
* [Dead Code Detector](https://github.com/shipmonk-rnd/dead-code-detector) ⭐ 513 | 🐛 14 | 🌐 PHP | 📅 2026-09-11 - A PHPStan extension for finding unused PHP code.
...
* [Design Patterns PHP](https://github.com/DesignPatternsPHP/DesignPatternsPHP) ⭐ 22,190 | 🐛 1 | 🌐 PHP | 📅 2025-02-03 - A repository of software patterns implemented in PHP.
...
* [Whoops](https://github.com/filp/whoops) ⭐ 13,233 | 🐛 8 | 🌐 PHP | 📅 2026-09-05 - A pretty error-handling library.
* [Symfony VarDumper](https://github.com/symfony/var-dumper) ⭐ 7,428 | 🐛 0 | 🌐 PHP | 📅 2026-09-04 - A variable dumper component.
* [xDebug](https://github.com/xdebug/xdebug) ⭐ 3,416 | 🐛 9 | 🌐 PHP | 📅 2026-09-08 - A debug and profile tool for PHP.
...
* [PHPBench](https://github.com/phpbench/phpbench) ⭐ 2,022 | 🐛 38 | 🌐 PHP | 📅 2026-06-14 - A benchmarking framework.
* [Tracy](https://github.com/nette/tracy) ⭐ 1,839 | 🐛 27 | 🌐 PHP | 📅 2026-08-18 - A simple error detection, logging and time measuring library.
* [PHPSpy](https://github.com/adsr/phpspy) ⭐ 1,500 | 🐛 23 | 🌐 C | 📅 2026-09-07 - A low-overhead sampling profiler.
...
* [LaraDumps](https://github.com/laradumps/laradumps) ⭐ 1,270 | 🐛 3 | 🌐 PHP | 📅 2026-08-16 - A debugging tool for Laravel with a dedicated desktop application.
* [PCOV](https://github.com/krakjoe/pcov) ⭐ 789 | 🐛 36 | 🌐 C | 📅 2026-07-21 - A self-contained code coverage compatible driver.
* [PHP Console](https://github.com/Seldaek/php-console) ⭐ 525 | 🐛 6 | 🌐 PHP | 📅 2021-03-14 - A web debugging console.
* [Metrics](https://github.com/beberlei/metrics) ⭐ 333 | 🐛 0 | 🌐 PHP | 📅 2026-09-09 - A simple metrics API library.
* [Trap](https://github.com/buggregator/trap) ⭐ 275 | 🐛 34 | 🌐 PHP | 📅 2026-09-08 - An extended variable dumper with a web interface and IDE plugin.
...
* [Box](https://github.com/box-project/box) ⭐ 1,323 | 🐛 101 | 🌐 PHP | 📅 2026-06-29 - A utility to build PHAR files.
...
* [Robo](https://github.com/consolidation/Robo) ⭐ 2,706 | 🐛 187 | 🌐 PHP | 📅 2025-11-14 - A PHP task runner with object-oriented configurations.
...
* [KnpMenu](https://github.com/KnpLabs/KnpMenu) ⭐ 1,395 | 🐛 22 | 🌐 PHP | 📅 2026-08-21 - A menu library.
...
* [Laravel Mix](https://github.com/laravel-mix/laravel-mix) ⭐ 5,220 | 🐛 270 | 🌐 JavaScript | 📅 2024-01-24 - An elegant wrapper around Webpack for the 80% use case.
* [Symfony Asset](https://github.com/symfony/asset) ⭐ 3,149 | 🐛 0 | 🌐 PHP | 📅 2026-09-10 - Manages URL generation and versioning of web assets.
* [Symfony Encore](https://github.com/symfony/webpack-encore) ⭐ 2,221 | 🐛 10 | 🌐 JavaScript | 📅 2026-09-11 - A simple but powerful API for processing and compiling assets built around Webpack.
...
* [PHPGeo](https://github.com/mjaschen/phpgeo) ⭐ 1,613 | 🐛 21 | 🌐 PHP | 📅 2026-08-06 - A simple geo library.
...
* [Carbon](https://github.com/briannesbitt/Carbon) ⭐ 16,599 | 🐛 5 | 🌐 PHP | 📅 2026-09-12 - A simple DateTime API extension.
* [Chronos](https://github.com/cakephp/chronos) ⭐ 1,362 | 🐛 2 | 🌐 PHP | 📅 2026-09-06 - A DateTime API extension supporting both mutable and immutable date/time.
* [Yasumi](https://github.com/azuyalabs/yasumi) ⭐ 1,101 | 🐛 8 | 🌐 PHP | 📅 2026-09-11 - A library to help you calculate the dates and names of holidays.
...
* [Swoole](https://github.com/swoole/swoole-src) ⭐ 18,917 | 🐛 74 | 🌐 C++ | 📅 2026-09-09 - An event-driven asynchronous and concurrent networking communication framework with high performance for PHP written in C.
* [Workerman](https://github.com/walkor/Workerman) ⭐ 11,549 | 🐛 107 | 🌐 PHP | 📅 2026-08-29 - An event-driven non-blocking I/O library.
...
* [CakePHP Event](https://github.com/cakephp/event) ⭐ 23 | 🐛 0 | 🌐 PHP | 📅 2026-09-08 - An event dispatcher library.
...
* [Monolog](https://github.com/Seldaek/monolog) ⭐ 21,404 | 🐛 3 | 🌐 PHP | 📅 2026-09-09 - A comprehensive logger.

### E-commerce

*Libraries and applications for taking payments and building online e-commerce stores.*

* [OmniPay](https://github.com/thephpleague/omnipay) ⭐ 6,061 | 🐛 109 | 🌐 PHP | 📅 2026-07-10 - A framework agnostic multi-gateway payment processing library.
* [Money](https://github.com/moneyphp/money) ⭐ 4,862 | 🐛 6 | 🌐 PHP | 📅 2026-07-07 - A PHP implementation of Fowler's money pattern.
* [Shopware](https://github.com/shopware/shopware) ⭐ 3,426 | 🐛 1,382 | 🌐 PHP | 📅 2026-09-13 - Highly customizable e-commerce software.
* [Brick Money](https://github.com/brick/money) ⭐ 1,927 | 🐛 5 | 🌐 PHP | 📅 2026-09-09 - A money library for PHP, with support for contexts, cash roundings, currency conversion.
* [Payum](https://github.com/payum/payum) ⭐ 1,924 | 🐛 99 | 🌐 PHP | 📅 2026-09-06 - A payment abstraction library.
* [Swap](https://github.com/florianv/swap) ⭐ 1,339 | 🐛 0 | 🌐 PHP | 📅 2026-06-17 - An exchange rates library.
* [Shopsys Framework](https://github.com/shopsys/shopsys/) ⭐ 350 | 🐛 118 | 🌐 PHP | 📅 2026-09-12 - An open source e-commerce platform for in-house development teams.
...
* [Dompdf](https://github.com/dompdf/dompdf) ⭐ 11,183 | 🐛 544 | 🌐 PHP | 📅 2026-08-02 - A HTML to PDF converter.
* [Browsershot](https://github.com/spatie/browsershot) ⭐ 5,244 | 🐛 0 | 🌐 PHP | 📅 2026-07-09 - Convert HTML to an image, PDF or string.
* [Snappy](https://github.com/KnpLabs/snappy) ⭐ 4,475 | 🐛 18 | 🌐 PHP | 📅 2026-07-29 - A PDF and image generation library.
* [Gotenberg](https://github.com/gotenberg/gotenberg-php) ⭐ 397 | 🐛 0 | 🌐 PHP | 📅 2026-08-14 - A PHP client for interacting with Gotenberg.
...
* [PHPSpreadsheet](https://github.com/PHPOffice/PhpSpreadsheet) ⭐ 13,989 | 🐛 95 | 🌐 PHP | 📅 2026-09-11 - A pure PHP library for reading and writing spreadsheet files (successor of PHPExcel).
* [PHPWord](https://github.com/PHPOffice/PHPWord) ⭐ 7,588 | 🐛 1,237 | 🌐 PHP | 📅 2026-09-08 - A library for working with Microsoft Word documents.
* [PHPPowerPoint](https://github.com/PHPOffice/PHPPresentation) ⭐ 1,374 | 🐛 251 | 🌐 PHP | 📅 2026-09-09 - A library for working with Microsoft PowerPoint Presentations.
* [OpenSpout](https://github.com/openspout/openspout) ⭐ 1,233 | 🐛 10 | 🌐 PHP | 📅 2026-09-13 - A community driven fork of `box/spout`, a PHP library to read and write spreadsheet files (CSV, XLSX and ODS), in a fast and scalable way.

### Database

*Libraries for interacting with databases using object-relational mapping (ORM) or datamapping techniques.*

* [ProxyManager](https://github.com/Ocramius/ProxyManager) ⭐ 4,943 | 🐛 55 | 🌐 PHP | 📅 2026-09-09 - A set of utilities to generate proxy objects for data mappers.
* [Doctrine Extensions](https://github.com/doctrine-extensions/DoctrineExtensions) ⭐ 4,138 | 🐛 58 | 🌐 PHP | 📅 2026-08-31 - A collection of Doctrine behavioural extensions.
* [Laravel Eloquent](https://github.com/illuminate/database) ⭐ 2,773 | 🐛 7 | 🌐 PHP | 📅 2026-09-11 - A simple ORM.
...
* [Aura.Sql](https://github.com/auraphp/Aura.Sql) ⭐ 566 | 🐛 2 | 🌐 PHP | 📅 2026-09-09 - Provides an extension to the native PDO along with a profiler and connection locator.
* [Aura.SqlQuery](https://github.com/auraphp/Aura.SqlQuery) ⭐ 456 | 🐛 3 | 🌐 PHP | 📅 2026-09-11 - Independent query builders for MySQL, PostgreSQL, SQLite, and Microsoft SQL Server.
...
* [CakePHP ORM](https://github.com/cakephp/orm) ⭐ 150 | 🐛 1 | 🌐 PHP | 📅 2026-09-12 - Object-Relational Mapper, implemented using the DataMapper pattern.
...
* [Predis](https://github.com/predis/predis) ⭐ 7,779 | 🐛 26 | 🌐 PHP | 📅 2026-09-11 - A feature-complete Redis library.
* [MongoDB PHP Library](https://github.com/mongodb/mongo-php-library) ⭐ 1,613 | 🐛 2 | 🌐 PHP | 📅 2026-09-10 - The official high-level MongoDB PHP library built on top of the MongoDB PHP Driver.
* [MongoDB](https://github.com/mongodb/mongo-php-driver) ⭐ 923 | 🐛 7 | 🌐 PHP | 📅 2026-09-05 - MongoDB PHP Driver.

### Queue

*Libraries for working with event and task queues.*

* [PHP AMQP](https://github.com/php-amqplib/php-amqplib) ⭐ 4,603 | 🐛 26 | 🌐 PHP | 📅 2026-01-06 - A pure PHP AMQP library.
* [Enqueue](https://github.com/php-enqueue/enqueue-dev) ⭐ 2,220 | 🐛 61 | 🌐 PHP | 📅 2026-08-30 - A message queue package for PHP that supports RabbitMQ, AMQP, STOMP, Amazon SQS, Redis and Doctrine transports.
* [Pheanstalk](https://github.com/pheanstalk/pheanstalk) ⭐ 1,921 | 🐛 7 | 🌐 PHP | 📅 2026-03-06 - A Beanstalkd client library.
* [BunnyPHP](https://github.com/jakubkulhan/bunny) ⭐ 748 | 🐛 43 | 🌐 PHP | 📅 2026-09-11 - A performant pure-PHP AMQP (RabbitMQ) sync and also async (ReactPHP) library.
...
* [ElasticSearch PHP](https://github.com/elastic/elasticsearch-php) ⭐ 5,338 | 🐛 20 | 🌐 PHP | 📅 2026-09-07 - The official client library for [ElasticSearch](https://www.elastic.co/).
* [Elastica](https://github.com/ruflin/Elastica) ⭐ 2,269 | 🐛 106 | 🌐 PHP | 📅 2026-09-07 - A client library for ElasticSearch.
...
* [PsySH](https://github.com/bobthecow/psysh) ⭐ 9,832 | 🐛 9 | 🌐 PHP | 📅 2026-09-10 - Another PHP REPL.
...
* [CLImate](https://github.com/thephpleague/climate) ⭐ 1,896 | 🐛 13 | 🌐 PHP | 📅 2026-08-27 - A library for outputting colors and special formatting.
...
* [Aura.Cli](https://github.com/auraphp/Aura.Cli) ⭐ 102 | 🐛 3 | 🌐 PHP | 📅 2026-09-09 - Provides the equivalent of request ( Context ) and response ( Stdio ) objects for the command line interface, including Getopt support, and an independent Help object for describing commands.

### Authentication and Authorization

*Libraries for implementing user authentication and authorization.*

* [Json Web Token](https://github.com/lcobucci/jwt) ⭐ 7,479 | 🐛 7 | 🌐 PHP | 📅 2026-09-13 - Json Tokens to authenticate and transmit information.
* [TwitterOAuth](https://github.com/abraham/twitteroauth) ⭐ 4,301 | 🐛 10 | 🌐 PHP | 📅 2026-09-07 - A Twitter OAuth library.
* [OAuth 2.0 Client](https://github.com/thephpleague/oauth2-client) ⭐ 3,821 | 🐛 64 | 🌐 PHP | 📅 2026-08-10 - An OAuth 2.0 client library.
...
* [OAuth 1.0 Client](https://github.com/thephpleague/oauth1-client) ⭐ 994 | 🐛 10 | 🌐 PHP | 📅 2024-12-10 - An OAuth 1.0 client library.
...
* [Aura.Auth](https://github.com/auraphp/Aura.Auth) ⭐ 135 | 🐛 0 | 🌐 PHP | 📅 2026-09-10 - Provides authentication functionality and session tracking using various adapters.
...
* [Parsedown](https://github.com/erusev/parsedown) ⭐ 15,060 | 🐛 179 | 🌐 PHP | 📅 2026-02-18 - Another Markdown parser.
* [PHP Markdown](https://github.com/michelf/php-markdown) ⭐ 3,462 | 🐛 98 | 🌐 PHP | 📅 2025-06-17 - A Markdown parser.
* [CommonMark PHP](https://github.com/thephpleague/commonmark) ⭐ 2,976 | 🐛 20 | 🌐 PHP | 📅 2026-09-13 - Highly-extensible Markdown parser which fully supports the [CommonMark spec](https://spec.commonmark.org/).
* [HTML to Markdown](https://github.com/thephpleague/html-to-markdown) ⭐ 1,906 | 🐛 21 | 🌐 PHP | 📅 2026-09-07 - Converts HTML into Markdown.
* [PHP CSS Parser](https://github.com/MyIntervals/PHP-CSS-Parser) ⭐ 1,828 | 🐛 160 | 🌐 PHP | 📅 2026-09-10 - A Parser for CSS Files written in PHP.
...
* [VObject](https://github.com/sabre-io/vobject) ⭐ 603 | 🐛 104 | 🌐 PHP | 📅 2026-09-04 - A library for parsing VCard and iCalendar objects.
* [Embera](https://github.com/mpratt/Embera) ⭐ 354 | 🐛 6 | 🌐 PHP | 📅 2025-10-07 - An Oembed consumer library.
* [Shiki PHP](https://github.com/spatie/shiki-php) ⭐ 314 | 🐛 0 | 🌐 JavaScript | 📅 2026-04-27 - A [Shiki](https://github.com/shikijs/shiki) ⭐ 13,799 | 🐛 106 | 🌐 TypeScript | 📅 2026-09-11 code highlighting package in PHP.
...
* [UUID](https://github.com/ramsey/uuid) ⭐ 12,631 | 🐛 26 | 🌐 PHP | 📅 2026-07-04 - A library for generating UUIDs.
* [Mobile-Detect](https://github.com/serbanghita/Mobile-Detect) ⭐ 10,682 | 🐛 18 | 🌐 PHP | 📅 2026-08-11 - A lightweight PHP class for detecting mobile devices (including tablets).
* [Agent](https://github.com/jenssegers/agent) ⭐ 4,852 | 🐛 87 | 🌐 PHP | 📅 2024-08-05 - A PHP desktop/mobile user agent parser, based on Mobiledetect.
* [SQL Formatter](https://github.com/jdorn/sql-formatter/) ⭐ 3,845 | 🐛 36 | 🌐 HTML | 📅 2023-05-26 - A library for formatting SQL statements.
* [Device Detector](https://github.com/matomo-org/device-detector) ⭐ 3,526 | 🐛 82 | 🌐 PHP | 📅 2026-09-11 - Another library for parsing user agent strings.
* [Slugify](https://github.com/cocur/slugify) ⭐ 2,898 | 🐛 32 | 🌐 PHP | 📅 2025-11-27 - A library to convert strings to slugs.
* [Jieba-PHP](https://github.com/fukuball/jieba-php) ⭐ 1,378 | 🐛 4 | 🌐 PHP | 📅 2025-12-16 - A PHP port of Python's jieba. Chinese text segmentation for natural language processing.
...
* [Url highlight](https://github.com/vstelmakh/url-highlight) ⭐ 103 | 🐛 0 | 🌐 PHP | 📅 2026-09-03 - A library for parsing URLs from text and converting them into clickable links.
...
* [Brick Math](https://github.com/brick/math) ⭐ 2,171 | 🐛 0 | 🌐 PHP | 📅 2026-09-12 - A library providing large number support: `BigInteger`, `BigDecimal` and `BigRational`.
...
* [Respect Validation](https://github.com/Respect/Validation) ⭐ 6,031 | 🐛 11 | 🌐 PHP | 📅 2026-09-13 - A simple validation library.
* [LibPhoneNumber for PHP](https://github.com/giggsey/libphonenumber-for-php) ⭐ 5,053 | 🐛 2 | 🌐 PHP | 📅 2026-09-10 - A PHP implementation of Google's phone number handling library.
* [JSON Schema](https://github.com/jsonrainbow/json-schema) ⭐ 3,632 | 🐛 19 | 🌐 PHP | 📅 2026-09-09 - A [JSON Schema](https://json-schema.org/) validation library.
* [HTML Purifier](https://github.com/ezyang/htmlpurifier) ⭐ 3,355 | 🐛 135 | 🌐 PHP | 📅 2026-09-05 - A standards compliant HTML filter.
...
* [Valinor](https://github.com/CuyZ/Valinor) ⭐ 1,529 | 🐛 32 | 🌐 PHP | 📅 2026-09-07 - A library for mapping to strongly typed value objects.
...
* [Symfony HTML Sanitizer](https://github.com/symfony/html-sanitizer) ⭐ 281 | 🐛 0 | 🌐 PHP | 📅 2026-09-09 - An HTML sanitizer library.
* [Aura.Filter](https://github.com/auraphp/Aura.Filter) ⭐ 157 | 🐛 3 | 🌐 PHP | 📅 2026-09-10 - Provides tools to validate and sanitize objects and arrays.
...
* [CakePHP Validation](https://github.com/cakephp/validation) ⭐ 43 | 🐛 0 | 🌐 PHP | 📅 2026-09-08 - Another validation library.

### API

*Libraries and web tools for developing APIs.*

* [Negotiation](https://github.com/willdurand/Negotiation) ⭐ 1,420 | 🐛 11 | 🌐 PHP | 📅 2023-08-03 - A content negotiation library.
...
* [Jane](https://github.com/janephp/janephp/) ⭐ 691 | 🐛 14 | 🌐 PHP | 📅 2026-09-11 - An OpenApi client generator with validation support.
...
* [Doctrine Cache](https://github.com/doctrine/cache) ⭐ 7,857 | 🐛 2 | 🌐 PHP | 📅 2025-10-08 - A caching library.
...
* [Laminas Cache](https://github.com/laminas/laminas-cache) ⭐ 107 | 🐛 15 | 🌐 PHP | 📅 2026-09-12 - Another caching library.
...
* [CakePHP Cache](https://github.com/cakephp/cache) ⭐ 50 | 🐛 0 | 🌐 PHP | 📅 2026-09-08 - A caching library.
...
* [Serializer](https://github.com/schmittjoh/serializer) ⭐ 2,342 | 🐛 171 | 🌐 PHP | 📅 2026-09-04 - A library for serializing and de-serializing data.
...
* [JSON Machine](https://github.com/halaxa/json-machine) ⭐ 1,329 | 🐛 5 | 🌐 PHP | 📅 2026-04-03 - Provides iteration over huge JSONs using simple `foreach`.
* [YaLinqo](https://github.com/Athari/YaLinqo) ⭐ 453 | 🐛 13 | 🌐 PHP | 📅 2025-10-19 - Yet Another LINQ to Objects for PHP.
* [msgpack.php](https://github.com/rybakit/msgpack.php) ⭐ 408 | 🐛 1 | 🌐 PHP | 📅 2026-04-25 - A pure PHP implementation of the [MessagePack](https://msgpack.org/) serialization format.
* [CakePHP Collection](https://github.com/cakephp/collection) ⭐ 91 | 🐛 0 | 🌐 PHP | 📅 2026-09-06 - A simple collections library.
* [Laminas Serializer](https://github.com/laminas/laminas-serializer) ⭐ 36 | 🐛 6 | 🌐 PHP | 📅 2026-09-08 - Another library for serialising and de-serialising data.

### Notifications

*Libraries for working with notification software.*

* [JoliNotif](https://github.com/jolicode/JoliNotif) ⭐ 1,441 | 🐛 2 | 🌐 PHP | 📅 2026-09-10 - A cross-platform library for desktop notification (support for Growl, notify-send, toaster, etc).

### Deployment

*Libraries for project deployment.*

* [Deployer](https://github.com/deployphp/deployer) ⭐ 11,107 | 🐛 18 | 🌐 PHP | 📅 2026-08-26 - A deployment tool.
...
* [CakePHP I18n](https://github.com/cakephp/i18n) ⭐ 29 | 🐛 0 | 🌐 PHP | 📅 2026-09-08 - Message translation and localization for dates and numbers.
...
* [PHP Dotenv](https://github.com/vlucas/phpdotenv) ⭐ 13,555 | 🐛 2 | 🌐 PHP | 📅 2026-08-24 - Parse and load environment variables from `.env` files.
...
* [OpenAI Client](https://github.com/openai-php/client) ⭐ 5,830 | 🐛 27 | 🌐 PHP | 📅 2026-09-11 - OpenAI PHP is a supercharged community-maintained PHP API client that allows you to interact with OpenAI API.
* [OpenAI Client for Laravel](https://github.com/openai-php/laravel) ⭐ 3,753 | 🐛 13 | 🌐 PHP | 📅 2026-07-27 - OpenAI PHP for Laravel is a supercharged PHP API client that allows you to interact with OpenAI API.
* [LLPhant](https://github.com/LLPhant/LLPhant) ⭐ 1,707 | 🐛 36 | 🌐 PHP | 📅 2026-09-07 - A comprehensive PHP Generative AI Framework using OpenAI GPT 4. Inspired by Langchain.
* [Instructor for PHP](https://github.com/cognesy/instructor-php) ⭐ 327 | 🐛 3 | 🌐 PHP | 📅 2026-09-13 - Structured data outputs with LLMs, in PHP.
...
* [Amazon Web Service SDK](https://github.com/aws/aws-sdk-php) ⭐ 6,206 | 🐛 21 | 🌐 PHP | 📅 2026-09-13 - The official PHP AWS SDK library.
* [Stripe](https://github.com/stripe/stripe-php) ⭐ 4,018 | 🐛 18 | 🌐 PHP | 📅 2026-09-13 - The official Stripe PHP library.
* [Github](https://github.com/KnpLabs/php-github-api) ⭐ 2,207 | 🐛 52 | 🌐 PHP | 📅 2026-08-18 - A library to interface with the Github API.
* [Twilio](https://github.com/twilio/twilio-php) ⭐ 1,636 | 🐛 60 | 🌐 PHP | 📅 2026-09-09 - The official Twilio PHP REST API.
...
* [Zephir](https://github.com/zephir-lang/zephir) ⭐ 3,386 | 🐛 46 | 🌐 PHP | 📅 2026-09-12 - A compiled language between PHP and C++ for developing PHP extensions.
...
* [Safe](https://github.com/thecodingmachine/safe) ⭐ 2,496 | 🐛 35 | 🌐 PHP | 📅 2026-08-17 - All PHP functions, rewritten to throw exceptions instead of returning false.
...
* [Static PHP CLI](https://github.com/crazywhalecc/static-php-cli) ⭐ 1,933 | 🐛 39 | 🌐 PHP | 📅 2026-09-10 - Build or [download](https://dl.static-php.dev/static-php-cli/) static versions of PHP CLI and FPM.
...
* [Docker PHP Extension Installer](https://github.com/mlocati/docker-php-extension-installer) ⭐ 4,967 | 🐛 14 | 🌐 Shell | 📅 2026-09-12 - Easily install PHP extensions in Docker containers.
* [Expose](https://github.com/exposedev/expose) ⭐ 4,571 | 🐛 28 | 🌐 PHP | 📅 2026-09-11 - An open-source PHP tunneling service.
* [DDEV](https://github.com/ddev/ddev) ⭐ 3,840 | 🐛 162 | 🌐 Go | 📅 2026-09-13 - A local web development environment system for PHP.
...
* [HHVM](https://github.com/facebook/hhvm) ⭐ 18,661 | 🐛 546 | 🌐 C++ | 📅 2026-09-13 - A Virtual Machine, Runtime and JIT for PHP by Facebook.
...
* [Cachet](https://github.com/cachethq/cachet) ⭐ 15,235 | 🐛 7 | 🌐 PHP | 📅 2026-09-07 - The open source status page system.
* [Mailpit](https://github.com/axllent/mailpit) ⭐ 10,352 | 🐛 2 | 🌐 Go | 📅 2026-09-06 - An email and SMTP testing tool for developers.
* [phpMyAdmin](https://github.com/phpmyadmin/phpmyadmin) ⭐ 7,937 | 🐛 932 | 🌐 PHP | 📅 2026-09-13 - A web interface for MySQL/MariaDB.
* [MailCatcher](https://github.com/sj26/mailcatcher) ⭐ 6,778 | 🐛 43 | 🌐 Ruby | 📅 2026-09-10 - A web tool for capturing and viewing emails.
...
* [RoadRunner](https://github.com/roadrunner-server/roadrunner) ⭐ 8,505 | 🐛 45 | 🌐 Go | 📅 2026-09-09 - High-performance PHP application server, load-balancer and process manager.
