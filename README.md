...
Please see [CONTRIBUTING](https://github.com/ziadoz/awesome-php/blob/master/CONTRIBUTING.md) ⭐ 32,688 | 🐛 90 | 📅 2026-07-13, [CODE-OF-CONDUCT](https://github.com/ziadoz/awesome-php/blob/master/CODE-OF-CONDUCT.md) ⭐ 32,688 | 🐛 90 | 📅 2026-07-13 and [COLLABORATING](https://github.com/ziadoz/awesome-php/blob/master/COLLABORATING.md) ⭐ 32,688 | 🐛 90 | 📅 2026-07-13 for details.
...
* [Pie](https://github.com/php/pie) ⭐ 2,015 | 🐛 14 | 🌐 PHP | 📅 2026-09-10 - The official PHP installer for extensions.
...
* [Satis](https://github.com/composer/satis) ⭐ 3,301 | 🐛 98 | 🌐 PHP | 📅 2026-09-10 - A static Composer repository generator.
...
* [Composer Require Checker](https://github.com/maglnet/ComposerRequireChecker) ⭐ 1,011 | 🐛 45 | 🌐 PHP | 📅 2026-09-11 - CLI tool to analyze composer dependencies and verify that no unknown symbols are used in the sources of a package.
...
* [Yii2](https://github.com/yiisoft/yii2/) ⭐ 14,292 | 🐛 336 | 🌐 PHP | 📅 2026-09-10 - A fast, secure, and efficient web framework.
* [Tempest](https://github.com/tempestphp/tempest-framework) ⭐ 2,267 | 🐛 27 | 🌐 PHP | 📅 2026-09-09 - A framework that gets out of your way.
...
* [WordPress](https://github.com/WordPress/WordPress) ⭐ 21,413 | 🐛 3 | 🌐 PHP | 📅 2026-09-11 - A blogging platform and CMS.
* [Grav](https://github.com/getgrav/grav) ⭐ 15,663 | 🐛 438 | 🌐 PHP | 📅 2026-09-11 - A modern flat-file CMS.
* [Magento](https://github.com/magento/magento2) ⭐ 12,185 | 🐛 2,180 | 🌐 PHP | 📅 2026-09-10 - A widely used open-source e-commerce platform.
* [CraftCMS](https://github.com/craftcms/cms) ⭐ 3,608 | 🐛 533 | 🌐 PHP | 📅 2026-09-12 - A flexible, user-friendly CMS for creating custom digital experiences on the web and beyond.
* [OpenMage](https://github.com/OpenMage/magento-lts) ⭐ 932 | 🐛 283 | 🌐 PHP | 📅 2026-09-11 - Fork of EoL Magento 1 e-commerce platform.
...
* [Guzzle](https://github.com/guzzle/guzzle) ⭐ 23,455 | 🐛 1 | 🌐 PHP | 📅 2026-09-06 - A comprehensive HTTP client.
...
* [Laminas Diactoros](https://github.com/laminas/laminas-diactoros) ⭐ 560 | 🐛 33 | 🌐 PHP | 📅 2026-09-07 - PSR-7 HTTP Message implementation.
...
* [PHPMailer](https://github.com/PHPMailer/PHPMailer) ⭐ 22,299 | 🐛 24 | 🌐 PHP | 📅 2026-09-10 - Another mailer solution.
* [Mautic](https://github.com/mautic/mautic) ⭐ 10,490 | 🐛 186 | 🌐 PHP | 📅 2026-09-11 - Email marketing automation.
...
* [Flysystem](https://github.com/thephpleague/Flysystem) ⭐ 13,588 | 🐛 103 | 🌐 PHP | 📅 2026-09-02 - Abstraction for local and remote filesystems.
...
* [Parquet](https://github.com/flow-php/parquet) ⭐ 61 | 🐛 0 | 🌐 PHP | 📅 2026-09-11 - PHP implementation of Parquet file format.
...
* [Intervention Image](https://github.com/Intervention/image) ⭐ 14,370 | 🐛 22 | 🌐 PHP | 📅 2026-08-29 - Another image manipulation library.
...
* [PHPUnit](https://github.com/sebastianbergmann/phpunit) ⭐ 20,053 | 🐛 23 | 🌐 PHP | 📅 2026-09-11 - A unit testing framework.
...
* [ParaTest](https://github.com/paratestphp/paratest) ⭐ 2,505 | 🐛 6 | 🌐 PHP | 📅 2026-09-09 - A parallel testing library for PHPUnit.
...
* [Foundry](https://github.com/zenstruck/foundry) ⭐ 800 | 🐛 28 | 🌐 PHP | 📅 2026-09-07 - A fixture factory generation library for Doctrine.
* [PHP MySQL Engine](https://github.com/vimeo/php-mysql-engine) ⭐ 563 | 🐛 10 | 🌐 PHP | 📅 2026-07-17 - A MySQL engine written in pure PHP.
* [Nette Tester](https://github.com/nette/tester) ⭐ 489 | 🐛 20 | 🌐 PHP | 📅 2026-07-17 - A productive and enjoyable parallel unit testing framework.
...
* [zircote/swagger-php](https://github.com/zircote/swagger-php) ⭐ 5,309 | 🐛 19 | 🌐 PHP | 📅 2026-09-12 - Generate OpenAPI documentation for your RESTful API.
...
* [SQLMap](https://github.com/sqlmapproject/sqlmap) ⭐ 38,420 | 🐛 32 | 🌐 Python | 📅 2026-09-08 - An automatic SQL injection and database takeover tool.
* [Zap](https://github.com/zaproxy/zaproxy) ⭐ 15,764 | 🐛 862 | 🌐 Java | 📅 2026-09-10 - An integrated penetration testing tool for web applications.
...
* [PHPGGC](https://github.com/ambionics/phpggc) ⭐ 3,886 | 🐛 22 | 🌐 PHP | 📅 2025-09-29 - A library of PHP unserializable payloads along with a tool to generate them.
...
* [Rector](https://github.com/rectorphp/rector) ⭐ 10,417 | 🐛 4 | 🌐 PHP | 📅 2026-09-11 - A tool to upgrade and refactor code.
* [GrumPHP](https://github.com/phpro/grumphp) ⭐ 4,314 | 🐛 7 | 🌐 PHP | 📅 2026-09-08 - A PHP code-quality tool.
* [Phpactor](https://github.com/phpactor/phpactor) ⭐ 1,925 | 🐛 292 | 🌐 PHP | 📅 2026-08-26 - PHP completion, refactoring and introspection tool.
...
* [Bladestan](https://github.com/bladestan/bladestan) ⭐ 375 | 🐛 22 | 🌐 PHP | 📅 2026-09-02 - A PHPStan extension for static analysis of Blade templates.
...
* [Laravel Pint](https://github.com/laravel/pint) ⭐ 3,164 | 🐛 9 | 🌐 PHP | 📅 2026-09-10 - A coding standards fixer library for Laravel.
* [PHP Mess Detector](https://github.com/phpmd/phpmd) ⭐ 2,453 | 🐛 65 | 🌐 PHP | 📅 2026-09-12 - A library that scans code for bugs, sub-optimal code, unused parameters and more.
...
* [PHPStan](https://github.com/phpstan/phpstan) ⭐ 14,101 | 🐛 1,091 | 🌐 PHP | 📅 2026-09-12 - A PHP Static Analysis Tool.
* [Larastan](https://github.com/larastan/larastan) ⭐ 6,500 | 🐛 107 | 🌐 PHP | 📅 2026-09-11 - A PHPStan wrapper for Laravel that adds static analysis to Laravel projects.
* [Psalm](https://github.com/vimeo/psalm) ⭐ 5,891 | 🐛 2,106 | 🌐 PHP | 📅 2026-09-10 - A static analysis tool for finding errors in PHP applications.
...
* [PHPCompatibility](https://github.com/PHPCompatibility/PHPCompatibility) ⭐ 2,302 | 🐛 100 | 🌐 PHP | 📅 2026-09-10 - A PHP compatibility checker for PHP CodeSniffer.
* [PHPDoc Parser](https://github.com/phpstan/phpdoc-parser) ⭐ 1,534 | 🐛 24 | 🌐 PHP | 📅 2026-09-09 - Next-gen phpDoc parser with support for intersection types and generics.
...
* [Dead Code Detector](https://github.com/shipmonk-rnd/dead-code-detector) ⭐ 513 | 🐛 11 | 🌐 PHP | 📅 2026-09-11 - A PHPStan extension for finding unused PHP code.
...
* [Design Patterns PHP](https://github.com/DesignPatternsPHP/DesignPatternsPHP) ⭐ 22,189 | 🐛 1 | 🌐 PHP | 📅 2025-02-03 - A repository of software patterns implemented in PHP.
...
* [Symfony VarDumper](https://github.com/symfony/var-dumper) ⭐ 7,427 | 🐛 0 | 🌐 PHP | 📅 2026-09-04 - A variable dumper component.
...
* [Carbon](https://github.com/briannesbitt/Carbon) ⭐ 16,599 | 🐛 5 | 🌐 PHP | 📅 2026-09-06 - A simple DateTime API extension.
...
* [Swoole](https://github.com/swoole/swoole-src) ⭐ 18,917 | 🐛 71 | 🌐 C++ | 📅 2026-09-09 - An event-driven asynchronous and concurrent networking communication framework with high performance for PHP written in C.
...
* [Ratchet](https://github.com/ratchetphp/Ratchet) ⭐ 6,438 | 🐛 9 | 🌐 PHP | 📅 2026-06-14 - A web socket library.
* [Amp](https://github.com/amphp/amp) ⭐ 4,435 | 🐛 20 | 🌐 PHP | 📅 2026-07-26 - An event-driven non-blocking I/O library.
...
* [OmniPay](https://github.com/thephpleague/omnipay) ⭐ 6,059 | 🐛 110 | 🌐 PHP | 📅 2026-07-10 - A framework agnostic multi-gateway payment processing library.
* [Money](https://github.com/moneyphp/money) ⭐ 4,862 | 🐛 6 | 🌐 PHP | 📅 2026-07-07 - A PHP implementation of Fowler's money pattern.
* [Shopware](https://github.com/shopware/shopware) ⭐ 3,426 | 🐛 1,380 | 🌐 PHP | 📅 2026-09-11 - Highly customizable e-commerce software.
...
* [Shopsys Framework](https://github.com/shopsys/shopsys/) ⭐ 350 | 🐛 116 | 🌐 PHP | 📅 2026-09-12 - An open source e-commerce platform for in-house development teams.
...
* [Dompdf](https://github.com/dompdf/dompdf) ⭐ 11,182 | 🐛 544 | 🌐 PHP | 📅 2026-08-02 - A HTML to PDF converter.
...
* [PHPSpreadsheet](https://github.com/PHPOffice/PhpSpreadsheet) ⭐ 13,988 | 🐛 95 | 🌐 PHP | 📅 2026-09-11 - A pure PHP library for reading and writing spreadsheet files (successor of PHPExcel).
* [PHPWord](https://github.com/PHPOffice/PHPWord) ⭐ 7,587 | 🐛 1,237 | 🌐 PHP | 📅 2026-09-08 - A library for working with Microsoft Word documents.
...
* [OpenSpout](https://github.com/openspout/openspout) ⭐ 1,233 | 🐛 10 | 🌐 PHP | 📅 2026-09-10 - A community driven fork of `box/spout`, a PHP library to read and write spreadsheet files (CSV, XLSX and ODS), in a fast and scalable way.
...
* [CakePHP ORM](https://github.com/cakephp/orm) ⭐ 150 | 🐛 1 | 🌐 PHP | 📅 2026-09-08 - Object-Relational Mapper, implemented using the DataMapper pattern.
...
* [Json Web Token](https://github.com/lcobucci/jwt) ⭐ 7,479 | 🐛 7 | 🌐 PHP | 📅 2026-09-10 - Json Tokens to authenticate and transmit information.
...
* [CommonMark PHP](https://github.com/thephpleague/commonmark) ⭐ 2,976 | 🐛 20 | 🌐 PHP | 📅 2026-09-12 - Highly-extensible Markdown parser which fully supports the [CommonMark spec](https://spec.commonmark.org/).
* [HTML to Markdown](https://github.com/thephpleague/html-to-markdown) ⭐ 1,906 | 🐛 21 | 🌐 PHP | 📅 2026-09-07 - Converts HTML into Markdown.
* [PHP CSS Parser](https://github.com/MyIntervals/PHP-CSS-Parser) ⭐ 1,827 | 🐛 159 | 🌐 PHP | 📅 2026-09-10 - A Parser for CSS Files written in PHP.
...
* [Shiki PHP](https://github.com/spatie/shiki-php) ⭐ 314 | 🐛 0 | 🌐 JavaScript | 📅 2026-04-27 - A [Shiki](https://github.com/shikijs/shiki) ⭐ 13,792 | 🐛 105 | 🌐 TypeScript | 📅 2026-09-11 code highlighting package in PHP.
...
* [UUID](https://github.com/ramsey/uuid) ⭐ 12,631 | 🐛 25 | 🌐 PHP | 📅 2026-07-04 - A library for generating UUIDs.
...
* [Agent](https://github.com/jenssegers/agent) ⭐ 4,851 | 🐛 87 | 🌐 PHP | 📅 2024-08-05 - A PHP desktop/mobile user agent parser, based on Mobiledetect.
* [SQL Formatter](https://github.com/jdorn/sql-formatter/) ⭐ 3,845 | 🐛 36 | 🌐 HTML | 📅 2023-05-26 - A library for formatting SQL statements.
* [Device Detector](https://github.com/matomo-org/device-detector) ⭐ 3,527 | 🐛 82 | 🌐 PHP | 📅 2026-09-11 - Another library for parsing user agent strings.
...
* [Brick Math](https://github.com/brick/math) ⭐ 2,163 | 🐛 0 | 🌐 PHP | 📅 2026-09-11 - A library providing large number support: `BigInteger`, `BigDecimal` and `BigRational`.
...
* [Respect Validation](https://github.com/Respect/Validation) ⭐ 6,031 | 🐛 11 | 🌐 PHP | 📅 2026-09-12 - A simple validation library.
...
* [HTML Purifier](https://github.com/ezyang/htmlpurifier) ⭐ 3,354 | 🐛 135 | 🌐 PHP | 📅 2026-09-05 - A standards compliant HTML filter.
...
* [Jane](https://github.com/janephp/janephp/) ⭐ 690 | 🐛 13 | 🌐 PHP | 📅 2026-09-11 - An OpenApi client generator with validation support.
...
* [Laminas Cache](https://github.com/laminas/laminas-cache) ⭐ 107 | 🐛 15 | 🌐 PHP | 📅 2026-09-08 - Another caching library.
...
* [OpenAI Client](https://github.com/openai-php/client) ⭐ 5,829 | 🐛 27 | 🌐 PHP | 📅 2026-09-11 - OpenAI PHP is a supercharged community-maintained PHP API client that allows you to interact with OpenAI API.
...
* [Instructor for PHP](https://github.com/cognesy/instructor-php) ⭐ 327 | 🐛 3 | 🌐 PHP | 📅 2026-09-01 - Structured data outputs with LLMs, in PHP.
...
* [PHP Mistral AI SDK](https://github.com/SoftCreatR/php-mistral-ai-sdk) ⭐ 19 | 🐛 0 | 🌐 PHP | 📅 2025-11-21 - A powerful and easy-to-use PHP SDK for the Mistral AI API, allowing seamless integration of advanced AI-powered features into your PHP projects.

### Third Party APIs

*Libraries for accessing third party APIs.*

* [Amazon Web Service SDK](https://github.com/aws/aws-sdk-php) ⭐ 6,206 | 🐛 21 | 🌐 PHP | 📅 2026-09-11 - The official PHP AWS SDK library.
* [Stripe](https://github.com/stripe/stripe-php) ⭐ 4,020 | 🐛 18 | 🌐 PHP | 📅 2026-09-12 - The official Stripe PHP library.
...
* [Zephir](https://github.com/zephir-lang/zephir) ⭐ 3,386 | 🐛 48 | 🌐 PHP | 📅 2026-09-11 - A compiled language between PHP and C++ for developing PHP extensions.
...
* [Docker PHP Extension Installer](https://github.com/mlocati/docker-php-extension-installer) ⭐ 4,967 | 🐛 14 | 🌐 Shell | 📅 2026-09-11 - Easily install PHP extensions in Docker containers.
* [Expose](https://github.com/exposedev/expose) ⭐ 4,571 | 🐛 28 | 🌐 PHP | 📅 2026-09-11 - An open-source PHP tunneling service.
* [DDEV](https://github.com/ddev/ddev) ⭐ 3,839 | 🐛 162 | 🌐 Go | 📅 2026-09-12 - A local web development environment system for PHP.
...
* [HHVM](https://github.com/facebook/hhvm) ⭐ 18,660 | 🐛 546 | 🌐 C++ | 📅 2026-09-12 - A Virtual Machine, Runtime and JIT for PHP by Facebook.
...
* [Cachet](https://github.com/cachethq/cachet) ⭐ 15,237 | 🐛 7 | 🌐 PHP | 📅 2026-09-07 - The open source status page system.
* [Mailpit](https://github.com/axllent/mailpit) ⭐ 10,350 | 🐛 2 | 🌐 Go | 📅 2026-09-06 - An email and SMTP testing tool for developers.
* [phpMyAdmin](https://github.com/phpmyadmin/phpmyadmin) ⭐ 7,937 | 🐛 932 | 🌐 PHP | 📅 2026-09-12 - A web interface for MySQL/MariaDB.
