...
* [Composer Require Checker](https://github.com/maglnet/ComposerRequireChecker) ⭐ 1,010 | 🐛 46 | 🌐 PHP | 📅 2026-09-01 - CLI tool to analyze composer dependencies and verify that no unknown symbols are used in the sources of a package.
...
* [Yii2](https://github.com/yiisoft/yii2/) ⭐ 14,297 | 🐛 333 | 🌐 PHP | 📅 2026-08-31 - A fast, secure, and efficient web framework.
* [Tempest](https://github.com/tempestphp/tempest-framework) ⭐ 2,258 | 🐛 28 | 🌐 PHP | 📅 2026-08-31 - A framework that gets out of your way.
...
* [Grav](https://github.com/getgrav/grav) ⭐ 15,656 | 🐛 445 | 🌐 PHP | 📅 2026-09-02 - A modern flat-file CMS.
* [Magento](https://github.com/magento/magento2) ⭐ 12,170 | 🐛 2,145 | 🌐 PHP | 📅 2026-09-02 - A widely used open-source e-commerce platform.
* [CraftCMS](https://github.com/craftcms/cms) ⭐ 3,606 | 🐛 522 | 🌐 PHP | 📅 2026-09-02 - A flexible, user-friendly CMS for creating custom digital experiences on the web and beyond.
...
* [Guzzle](https://github.com/guzzle/guzzle) ⭐ 23,459 | 🐛 2 | 🌐 PHP | 📅 2026-08-24 - A comprehensive HTTP client.
...
* [PHPMailer](https://github.com/PHPMailer/PHPMailer) ⭐ 22,287 | 🐛 30 | 🌐 PHP | 📅 2026-09-01 - Another mailer solution.
* [Mautic](https://github.com/mautic/mautic) ⭐ 10,430 | 🐛 171 | 🌐 PHP | 📅 2026-09-01 - Email marketing automation.
...
* [Flysystem](https://github.com/thephpleague/Flysystem) ⭐ 13,586 | 🐛 102 | 🌐 PHP | 📅 2026-09-02 - Abstraction for local and remote filesystems.
...
* [CSV](https://github.com/thephpleague/csv) ⭐ 3,481 | 🐛 2 | 🌐 PHP | 📅 2026-08-21 - A CSV data manipulation library.
...
* [PHPUnit](https://github.com/sebastianbergmann/phpunit) ⭐ 20,044 | 🐛 21 | 🌐 PHP | 📅 2026-09-02 - A unit testing framework.
...
* [ParaTest](https://github.com/paratestphp/paratest) ⭐ 2,498 | 🐛 6 | 🌐 PHP | 📅 2026-09-01 - A parallel testing library for PHPUnit.
* [Infection](https://github.com/infection/infection) ⭐ 2,237 | 🐛 217 | 🌐 PHP | 📅 2026-09-01 - An AST-based PHP Mutation testing framework.
...
* [Foundry](https://github.com/zenstruck/foundry) ⭐ 800 | 🐛 34 | 🌐 PHP | 📅 2026-08-26 - A fixture factory generation library for Doctrine.
* [PHP MySQL Engine](https://github.com/vimeo/php-mysql-engine) ⭐ 562 | 🐛 10 | 🌐 PHP | 📅 2026-07-17 - A MySQL engine written in pure PHP.
...
* [zircote/swagger-php](https://github.com/zircote/swagger-php) ⭐ 5,307 | 🐛 17 | 🌐 PHP | 📅 2026-09-01 - Generate OpenAPI documentation for your RESTful API.
* [Scramble](https://github.com/dedoc/scramble) ⭐ 2,196 | 🐛 19 | 🌐 PHP | 📅 2026-08-31 - Automatically generates OpenAPI documentation from your code without annotations.
...
* [SQLMap](https://github.com/sqlmapproject/sqlmap) ⭐ 38,340 | 🐛 32 | 🌐 Python | 📅 2026-09-02 - An automatic SQL injection and database takeover tool.
* [Zap](https://github.com/zaproxy/zaproxy) ⭐ 15,719 | 🐛 859 | 🌐 Java | 📅 2026-09-01 - An integrated penetration testing tool for web applications.
...
* [Roave Security Advisories](https://github.com/Roave/SecurityAdvisories) ⭐ 2,914 | 🐛 1 | 📅 2026-09-01 - This package ensures that your application doesn't have installed dependencies with known security vulnerabilities.
...
* [AntiXSS](https://github.com/voku/anti-xss) ⭐ 712 | 🐛 2 | 🌐 PHP | 📅 2026-09-01 - A library that tries to preventing Cross-Site Scripting (XSS) attacks by blacklisting.
...
* [Rector](https://github.com/rectorphp/rector) ⭐ 10,412 | 🐛 4 | 🌐 PHP | 📅 2026-09-02 - A tool to upgrade and refactor code.
...
* [Better Reflection](https://github.com/Roave/BetterReflection) ⭐ 1,247 | 🐛 18 | 🌐 PHP | 📅 2026-09-01 - An AST-based reflection library that allows analysis and manipulation of code.
...
* [Editorconfig-Checker](https://github.com/editorconfig-checker/editorconfig-checker.php) ⭐ 76 | 🐛 7 | 🌐 PHP | 📅 2026-09-01 - A command line utility which verifies that your files implement your `.editorconfig` rules.
...
* [PHPStan](https://github.com/phpstan/phpstan) ⭐ 14,092 | 🐛 1,145 | 🌐 PHP | 📅 2026-09-01 - A PHP Static Analysis Tool.
* [Larastan](https://github.com/larastan/larastan) ⭐ 6,502 | 🐛 113 | 🌐 PHP | 📅 2026-09-02 - A PHPStan wrapper for Laravel that adds static analysis to Laravel projects.
* [Psalm](https://github.com/vimeo/psalm) ⭐ 5,888 | 🐛 2,101 | 🌐 PHP | 📅 2026-07-13 - A static analysis tool for finding errors in PHP applications.
* [phan](https://github.com/phan/phan) ⭐ 5,624 | 🐛 794 | 🌐 PHP | 📅 2026-08-26 - A static analyzer based on PHP 7+ and the php-ast extension.
* [Mago](https://github.com/carthage-software/mago) ⭐ 3,421 | 🐛 107 | 🌐 Rust | 📅 2026-08-29 - A toolchain for PHP that aims to improve the developer experience.
...
* [Swoole](https://github.com/swoole/swoole-src) ⭐ 18,915 | 🐛 41 | 🌐 C++ | 📅 2026-09-02 - An event-driven asynchronous and concurrent networking communication framework with high performance for PHP written in C.
* [Workerman](https://github.com/walkor/Workerman) ⭐ 11,545 | 🐛 107 | 🌐 PHP | 📅 2026-08-29 - An event-driven non-blocking I/O library.
...
* [Monolog](https://github.com/Seldaek/monolog) ⭐ 21,401 | 🐛 7 | 🌐 PHP | 📅 2026-09-02 - A comprehensive logger.
...
* [Shopware](https://github.com/shopware/shopware) ⭐ 3,415 | 🐛 1,310 | 🌐 PHP | 📅 2026-09-02 - Highly customizable e-commerce software.
...
* [Shopsys Framework](https://github.com/shopsys/shopsys/) ⭐ 349 | 🐛 126 | 🌐 PHP | 📅 2026-09-02 - An open source e-commerce platform for in-house development teams.
...
* [Dompdf](https://github.com/dompdf/dompdf) ⭐ 11,180 | 🐛 539 | 🌐 PHP | 📅 2026-08-02 - A HTML to PDF converter.
...
* [PHPSpreadsheet](https://github.com/PHPOffice/PhpSpreadsheet) ⭐ 13,983 | 🐛 98 | 🌐 PHP | 📅 2026-09-02 - A pure PHP library for reading and writing spreadsheet files (successor of PHPExcel).
...
* [PHPPowerPoint](https://github.com/PHPOffice/PHPPresentation) ⭐ 1,373 | 🐛 244 | 🌐 PHP | 📅 2026-09-02 - A library for working with Microsoft PowerPoint Presentations.
...
* [ProxyManager](https://github.com/Ocramius/ProxyManager) ⭐ 4,943 | 🐛 55 | 🌐 PHP | 📅 2026-09-02 - A set of utilities to generate proxy objects for data mappers.
...
* [Json Web Token](https://github.com/lcobucci/jwt) ⭐ 7,479 | 🐛 9 | 🌐 PHP | 📅 2026-09-02 - Json Tokens to authenticate and transmit information.
...
* [CommonMark PHP](https://github.com/thephpleague/commonmark) ⭐ 2,973 | 🐛 20 | 🌐 PHP | 📅 2026-09-02 - Highly-extensible Markdown parser which fully supports the [CommonMark spec](https://spec.commonmark.org/).
...
* [Respect Validation](https://github.com/Respect/Validation) ⭐ 6,028 | 🐛 13 | 🌐 PHP | 📅 2026-09-02 - A simple validation library.
...
* [HTML Purifier](https://github.com/ezyang/htmlpurifier) ⭐ 3,352 | 🐛 134 | 🌐 PHP | 📅 2026-08-12 - A standards compliant HTML filter.
...
* [Valinor](https://github.com/CuyZ/Valinor) ⭐ 1,527 | 🐛 31 | 🌐 PHP | 📅 2026-09-01 - A library for mapping to strongly typed value objects.
...
* [Amazon Web Service SDK](https://github.com/aws/aws-sdk-php) ⭐ 6,202 | 🐛 19 | 🌐 PHP | 📅 2026-09-01 - The official PHP AWS SDK library.
* [Stripe](https://github.com/stripe/stripe-php) ⭐ 4,018 | 🐛 14 | 🌐 PHP | 📅 2026-09-02 - The official Stripe PHP library.
...
* [Laravel Serializable Closure](https://github.com/laravel/serializable-closure) ⭐ 608 | 🐛 3 | 🌐 PHP | 📅 2026-08-25 - A library that allows Closures to be serialized.
...
* [Static PHP CLI](https://github.com/crazywhalecc/static-php-cli) ⭐ 1,930 | 🐛 38 | 🌐 PHP | 📅 2026-08-22 - Build or [download](https://dl.static-php.dev/static-php-cli/) static versions of PHP CLI and FPM.
...
* [Docker PHP Extension Installer](https://github.com/mlocati/docker-php-extension-installer) ⭐ 4,964 | 🐛 13 | 🌐 Shell | 📅 2026-09-01 - Easily install PHP extensions in Docker containers.
* [Expose](https://github.com/exposedev/expose) ⭐ 4,570 | 🐛 28 | 🌐 PHP | 📅 2026-07-09 - An open-source PHP tunneling service.
* [DDEV](https://github.com/ddev/ddev) ⭐ 3,830 | 🐛 162 | 🌐 Go | 📅 2026-09-02 - A local web development environment system for PHP.
...
* [HHVM](https://github.com/facebook/hhvm) ⭐ 18,659 | 🐛 547 | 🌐 C++ | 📅 2026-09-02 - A Virtual Machine, Runtime and JIT for PHP by Facebook.
...
* [Mailpit](https://github.com/axllent/mailpit) ⭐ 10,251 | 🐛 1 | 🌐 Go | 📅 2026-08-29 - An email and SMTP testing tool for developers.
* [phpMyAdmin](https://github.com/phpmyadmin/phpmyadmin) ⭐ 7,922 | 🐛 941 | 🌐 PHP | 📅 2026-09-01 - A web interface for MySQL/MariaDB.
* [MailCatcher](https://github.com/sj26/mailcatcher) ⭐ 6,776 | 🐛 43 | 🌐 Ruby | 📅 2026-09-02 - A web tool for capturing and viewing emails.
