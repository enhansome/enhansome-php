...
Please see [CONTRIBUTING](https://github.com/ziadoz/awesome-php/blob/master/CONTRIBUTING.md) ⭐ 32,683 | 🐛 89 | 📅 2026-07-13, [CODE-OF-CONDUCT](https://github.com/ziadoz/awesome-php/blob/master/CODE-OF-CONDUCT.md) ⭐ 32,683 | 🐛 89 | 📅 2026-07-13 and [COLLABORATING](https://github.com/ziadoz/awesome-php/blob/master/COLLABORATING.md) ⭐ 32,683 | 🐛 89 | 📅 2026-07-13 for details.
...
* [Pie](https://github.com/php/pie) ⭐ 2,013 | 🐛 14 | 🌐 PHP | 📅 2026-09-08 - The official PHP installer for extensions.
...
* [Satis](https://github.com/composer/satis) ⭐ 3,300 | 🐛 98 | 🌐 PHP | 📅 2026-09-04 - A static Composer repository generator.
...
* [Composer Unused](https://github.com/composer-unused/composer-unused) ⭐ 1,688 | 🐛 15 | 🌐 PHP | 📅 2026-09-04 - A CLI Tool to scan for unused composer packages.
* [Composer Normalize](https://github.com/ergebnis/composer-normalize) ⭐ 1,123 | 🐛 27 | 🌐 PHP | 📅 2026-09-06 - A plugin for normalizing `composer.json` files.
...
* [Composer Require Checker](https://github.com/maglnet/ComposerRequireChecker) ⭐ 1,009 | 🐛 45 | 🌐 PHP | 📅 2026-09-05 - CLI tool to analyze composer dependencies and verify that no unknown symbols are used in the sources of a package.
...
* [Tempest](https://github.com/tempestphp/tempest-framework) ⭐ 2,264 | 🐛 26 | 🌐 PHP | 📅 2026-09-09 - A framework that gets out of your way.
...
* [WordPress](https://github.com/WordPress/WordPress) ⭐ 21,399 | 🐛 3 | 🌐 PHP | 📅 2026-09-09 - A blogging platform and CMS.
* [Grav](https://github.com/getgrav/grav) ⭐ 15,663 | 🐛 451 | 🌐 PHP | 📅 2026-09-06 - A modern flat-file CMS.
* [Magento](https://github.com/magento/magento2) ⭐ 12,182 | 🐛 2,178 | 🌐 PHP | 📅 2026-09-08 - A widely used open-source e-commerce platform.
* [CraftCMS](https://github.com/craftcms/cms) ⭐ 3,607 | 🐛 528 | 🌐 PHP | 📅 2026-09-09 - A flexible, user-friendly CMS for creating custom digital experiences on the web and beyond.
* [OpenMage](https://github.com/OpenMage/magento-lts) ⭐ 931 | 🐛 287 | 🌐 PHP | 📅 2026-09-09 - Fork of EoL Magento 1 e-commerce platform.
...
* [Aura.Router](https://github.com/auraphp/Aura.Router) ⭐ 501 | 🐛 3 | 🌐 PHP | 📅 2025-05-02 - A full-featured routing library.
...
* [Guzzle](https://github.com/guzzle/guzzle) ⭐ 23,457 | 🐛 1 | 🌐 PHP | 📅 2026-09-06 - A comprehensive HTTP client.
* [Requests](https://github.com/WordPress/Requests) ⭐ 3,574 | 🐛 126 | 🌐 PHP | 📅 2026-09-02 - A simple HTTP library.
...
* [Symfony HTTP Client](https://github.com/symfony/http-client) ⭐ 2,029 | 🐛 0 | 🌐 PHP | 📅 2026-09-08 - A component to fetch HTTP resources synchronously or asynchronously.
...
* [PHPMailer](https://github.com/PHPMailer/PHPMailer) ⭐ 22,293 | 🐛 30 | 🌐 PHP | 📅 2026-09-06 - Another mailer solution.
* [Mautic](https://github.com/mautic/mautic) ⭐ 10,466 | 🐛 186 | 🌐 PHP | 📅 2026-09-09 - Email marketing automation.
...
* [Symfony Mailer](https://github.com/symfony/mailer) ⭐ 1,594 | 🐛 0 | 🌐 PHP | 📅 2026-09-04 - A powerful library for creating and sending emails.
...
* [Flysystem](https://github.com/thephpleague/Flysystem) ⭐ 13,585 | 🐛 103 | 🌐 PHP | 📅 2026-09-02 - Abstraction for local and remote filesystems.
...
* [PHPUnit](https://github.com/sebastianbergmann/phpunit) ⭐ 20,051 | 🐛 23 | 🌐 PHP | 📅 2026-09-09 - A unit testing framework.
...
* [ParaTest](https://github.com/paratestphp/paratest) ⭐ 2,501 | 🐛 6 | 🌐 PHP | 📅 2026-09-09 - A parallel testing library for PHPUnit.
* [Infection](https://github.com/infection/infection) ⭐ 2,241 | 🐛 211 | 🌐 PHP | 📅 2026-09-08 - An AST-based PHP Mutation testing framework.
* [PHPSpec](https://github.com/phpspec/phpspec) ⭐ 1,901 | 🐛 137 | 🌐 PHP | 📅 2026-08-08 - A design by specification unit testing library.
...
* [Setup PHP](https://github.com/shivammathur/setup-php) ⭐ 3,255 | 🐛 6 | 🌐 TypeScript | 📅 2026-09-09 - A GitHub Action for PHP.
...
* [Scramble](https://github.com/dedoc/scramble) ⭐ 2,200 | 🐛 14 | 🌐 PHP | 📅 2026-09-08 - Automatically generates OpenAPI documentation from your code without annotations.
...
* [SQLMap](https://github.com/sqlmapproject/sqlmap) ⭐ 38,388 | 🐛 32 | 🌐 Python | 📅 2026-09-08 - An automatic SQL injection and database takeover tool.
* [Zap](https://github.com/zaproxy/zaproxy) ⭐ 15,748 | 🐛 860 | 🌐 Java | 📅 2026-09-08 - An integrated penetration testing tool for web applications.
* [Halite](https://paragonie.com/project/halite) - A simple library for encryption using [libsodium](https://github.com/jedisct1/libsodium) ⭐ 13,943 | 🐛 1 | 🌐 C | 📅 2026-09-09.
...
* [Roave Security Advisories](https://github.com/Roave/SecurityAdvisories) ⭐ 2,913 | 🐛 1 | 📅 2026-09-08 - This package ensures that your application doesn't have installed dependencies with known security vulnerabilities.
...
* [AntiXSS](https://github.com/voku/anti-xss) ⭐ 713 | 🐛 2 | 🌐 PHP | 📅 2026-09-08 - A library that tries to preventing Cross-Site Scripting (XSS) attacks by blacklisting.
...
* [Rector](https://github.com/rectorphp/rector) ⭐ 10,417 | 🐛 4 | 🌐 PHP | 📅 2026-09-09 - A tool to upgrade and refactor code.
...
* [Better Reflection](https://github.com/Roave/BetterReflection) ⭐ 1,247 | 🐛 18 | 🌐 PHP | 📅 2026-09-05 - An AST-based reflection library that allows analysis and manipulation of code.
...
* [PHP CS Fixer](https://github.com/PHP-CS-Fixer/PHP-CS-Fixer) ⭐ 13,549 | 🐛 83 | 🌐 PHP | 📅 2026-09-08 - A coding standards fixer library.
* [Laravel Pint](https://github.com/laravel/pint) ⭐ 3,162 | 🐛 8 | 🌐 PHP | 📅 2026-09-08 - A coding standards fixer library for Laravel.
...
* [PHP CodeSniffer](https://github.com/PHPCSStandards/PHP_CodeSniffer) ⭐ 1,552 | 🐛 204 | 🌐 PHP | 📅 2026-09-05 - A library that detects and can auto-fix PHP, CSS and JS coding standard violations.
...
* [PHPStan](https://github.com/phpstan/phpstan) ⭐ 14,100 | 🐛 1,131 | 🌐 PHP | 📅 2026-09-09 - A PHP Static Analysis Tool.
* [Larastan](https://github.com/larastan/larastan) ⭐ 6,498 | 🐛 108 | 🌐 PHP | 📅 2026-09-09 - A PHPStan wrapper for Laravel that adds static analysis to Laravel projects.
* [Psalm](https://github.com/vimeo/psalm) ⭐ 5,891 | 🐛 2,104 | 🌐 PHP | 📅 2026-07-13 - A static analysis tool for finding errors in PHP applications.
* [phan](https://github.com/phan/phan) ⭐ 5,623 | 🐛 794 | 🌐 PHP | 📅 2026-09-05 - A static analyzer based on PHP 7+ and the php-ast extension.
* [Mago](https://github.com/carthage-software/mago) ⭐ 3,430 | 🐛 97 | 🌐 Rust | 📅 2026-09-09 - A toolchain for PHP that aims to improve the developer experience.
...
* [PHPDoc Parser](https://github.com/phpstan/phpdoc-parser) ⭐ 1,534 | 🐛 23 | 🌐 PHP | 📅 2026-09-07 - Next-gen phpDoc parser with support for intersection types and generics.
...
* [Dead Code Detector](https://github.com/shipmonk-rnd/dead-code-detector) ⭐ 511 | 🐛 10 | 🌐 PHP | 📅 2026-08-31 - A PHPStan extension for finding unused PHP code.
...
* [Iter](https://github.com/nikic/iter) ⭐ 1,140 | 🐛 16 | 🌐 PHP | 📅 2025-08-10 - A library that provides iteration primitives using generators.
...
* [PHPBench](https://github.com/phpbench/phpbench) ⭐ 2,020 | 🐛 38 | 🌐 PHP | 📅 2026-06-14 - A benchmarking framework.
...
* [Swoole](https://github.com/swoole/swoole-src) ⭐ 18,915 | 🐛 54 | 🌐 C++ | 📅 2026-09-08 - An event-driven asynchronous and concurrent networking communication framework with high performance for PHP written in C.
...
* [Money](https://github.com/moneyphp/money) ⭐ 4,860 | 🐛 6 | 🌐 PHP | 📅 2026-07-07 - A PHP implementation of Fowler's money pattern.
* [Shopware](https://github.com/shopware/shopware) ⭐ 3,421 | 🐛 1,336 | 🌐 PHP | 📅 2026-09-09 - Highly customizable e-commerce software.
* [Brick Money](https://github.com/brick/money) ⭐ 1,926 | 🐛 5 | 🌐 PHP | 📅 2026-09-08 - A money library for PHP, with support for contexts, cash roundings, currency conversion.
...
* [Shopsys Framework](https://github.com/shopsys/shopsys/) ⭐ 349 | 🐛 117 | 🌐 PHP | 📅 2026-09-09 - An open source e-commerce platform for in-house development teams.
...
* [Dompdf](https://github.com/dompdf/dompdf) ⭐ 11,180 | 🐛 544 | 🌐 PHP | 📅 2026-08-02 - A HTML to PDF converter.
...
* [PHPSpreadsheet](https://github.com/PHPOffice/PhpSpreadsheet) ⭐ 13,986 | 🐛 101 | 🌐 PHP | 📅 2026-09-04 - A pure PHP library for reading and writing spreadsheet files (successor of PHPExcel).
* [PHPWord](https://github.com/PHPOffice/PHPWord) ⭐ 7,586 | 🐛 1,237 | 🌐 PHP | 📅 2026-09-08 - A library for working with Microsoft Word documents.
* [PHPPowerPoint](https://github.com/PHPOffice/PHPPresentation) ⭐ 1,373 | 🐛 251 | 🌐 PHP | 📅 2026-09-09 - A library for working with Microsoft PowerPoint Presentations.
* [OpenSpout](https://github.com/openspout/openspout) ⭐ 1,231 | 🐛 10 | 🌐 PHP | 📅 2026-09-08 - A community driven fork of `box/spout`, a PHP library to read and write spreadsheet files (CSV, XLSX and ODS), in a fast and scalable way.
...
* [Doctrine Extensions](https://github.com/doctrine-extensions/DoctrineExtensions) ⭐ 4,138 | 🐛 57 | 🌐 PHP | 📅 2026-08-31 - A collection of Doctrine behavioural extensions.
* [Laravel Eloquent](https://github.com/illuminate/database) ⭐ 2,773 | 🐛 7 | 🌐 PHP | 📅 2026-09-09 - A simple ORM.
...
* [Predis](https://github.com/predis/predis) ⭐ 7,779 | 🐛 29 | 🌐 PHP | 📅 2026-09-01 - A feature-complete Redis library.
...
* [PsySH](https://github.com/bobthecow/psysh) ⭐ 9,832 | 🐛 9 | 🌐 PHP | 📅 2026-09-09 - Another PHP REPL.
...
* [Json Web Token](https://github.com/lcobucci/jwt) ⭐ 7,479 | 🐛 9 | 🌐 PHP | 📅 2026-09-09 - Json Tokens to authenticate and transmit information.
...
* [Aura.Auth](https://github.com/auraphp/Aura.Auth) ⭐ 135 | 🐛 1 | 🌐 PHP | 📅 2026-09-08 - Provides authentication functionality and session tracking using various adapters.
...
* [CommonMark PHP](https://github.com/thephpleague/commonmark) ⭐ 2,976 | 🐛 20 | 🌐 PHP | 📅 2026-09-09 - Highly-extensible Markdown parser which fully supports the [CommonMark spec](https://spec.commonmark.org/).
* [HTML to Markdown](https://github.com/thephpleague/html-to-markdown) ⭐ 1,906 | 🐛 21 | 🌐 PHP | 📅 2026-09-07 - Converts HTML into Markdown.
* [PHP CSS Parser](https://github.com/MyIntervals/PHP-CSS-Parser) ⭐ 1,827 | 🐛 159 | 🌐 PHP | 📅 2026-09-08 - A Parser for CSS Files written in PHP.
...
* [VObject](https://github.com/sabre-io/vobject) ⭐ 603 | 🐛 103 | 🌐 PHP | 📅 2026-09-04 - A library for parsing VCard and iCalendar objects.
* [Embera](https://github.com/mpratt/Embera) ⭐ 354 | 🐛 6 | 🌐 PHP | 📅 2025-10-07 - An Oembed consumer library.
* [Shiki PHP](https://github.com/spatie/shiki-php) ⭐ 313 | 🐛 0 | 🌐 JavaScript | 📅 2026-04-27 - A [Shiki](https://github.com/shikijs/shiki) ⭐ 13,787 | 🐛 116 | 🌐 TypeScript | 📅 2026-08-10 code highlighting package in PHP.
...
* [Device Detector](https://github.com/matomo-org/device-detector) ⭐ 3,527 | 🐛 80 | 🌐 PHP | 📅 2026-09-06 - Another library for parsing user agent strings.
...
* [Respect Validation](https://github.com/Respect/Validation) ⭐ 6,030 | 🐛 12 | 🌐 PHP | 📅 2026-09-09 - A simple validation library.
...
* [JSON Schema](https://github.com/jsonrainbow/json-schema) ⭐ 3,631 | 🐛 18 | 🌐 PHP | 📅 2026-09-06 - A [JSON Schema](https://json-schema.org/) validation library.
...
* [Symfony HTML Sanitizer](https://github.com/symfony/html-sanitizer) ⭐ 282 | 🐛 0 | 🌐 PHP | 📅 2026-09-04 - An HTML sanitizer library.
* [Aura.Filter](https://github.com/auraphp/Aura.Filter) ⭐ 157 | 🐛 3 | 🌐 PHP | 📅 2026-09-09 - Provides tools to validate and sanitize objects and arrays.
...
* [JoliNotif](https://github.com/jolicode/JoliNotif) ⭐ 1,441 | 🐛 2 | 🌐 PHP | 📅 2026-09-08 - A cross-platform library for desktop notification (support for Growl, notify-send, toaster, etc).
...
* [PHP Dotenv](https://github.com/vlucas/phpdotenv) ⭐ 13,552 | 🐛 2 | 🌐 PHP | 📅 2026-08-24 - Parse and load environment variables from `.env` files.
...
* [Amazon Web Service SDK](https://github.com/aws/aws-sdk-php) ⭐ 6,204 | 🐛 21 | 🌐 PHP | 📅 2026-09-08 - The official PHP AWS SDK library.
* [Stripe](https://github.com/stripe/stripe-php) ⭐ 4,019 | 🐛 15 | 🌐 PHP | 📅 2026-09-09 - The official Stripe PHP library.
* [Github](https://github.com/KnpLabs/php-github-api) ⭐ 2,207 | 🐛 52 | 🌐 PHP | 📅 2026-08-18 - A library to interface with the Github API.
* [Twilio](https://github.com/twilio/twilio-php) ⭐ 1,635 | 🐛 61 | 🌐 PHP | 📅 2026-09-04 - The official Twilio PHP REST API.
...
* [Zephir](https://github.com/zephir-lang/zephir) ⭐ 3,386 | 🐛 46 | 🌐 PHP | 📅 2026-09-08 - A compiled language between PHP and C++ for developing PHP extensions.
...
* [Docker PHP Extension Installer](https://github.com/mlocati/docker-php-extension-installer) ⭐ 4,966 | 🐛 13 | 🌐 Shell | 📅 2026-09-08 - Easily install PHP extensions in Docker containers.
* [Expose](https://github.com/exposedev/expose) ⭐ 4,571 | 🐛 28 | 🌐 PHP | 📅 2026-07-09 - An open-source PHP tunneling service.
* [DDEV](https://github.com/ddev/ddev) ⭐ 3,834 | 🐛 169 | 🌐 Go | 📅 2026-09-09 - A local web development environment system for PHP.
...
* [HHVM](https://github.com/facebook/hhvm) ⭐ 18,661 | 🐛 547 | 🌐 C++ | 📅 2026-09-08 - A Virtual Machine, Runtime and JIT for PHP by Facebook.
...
* [Mailpit](https://github.com/axllent/mailpit) ⭐ 10,326 | 🐛 1 | 🌐 Go | 📅 2026-09-06 - An email and SMTP testing tool for developers.
* [phpMyAdmin](https://github.com/phpmyadmin/phpmyadmin) ⭐ 7,931 | 🐛 938 | 🌐 PHP | 📅 2026-09-08 - A web interface for MySQL/MariaDB.
* [MailCatcher](https://github.com/sj26/mailcatcher) ⭐ 6,776 | 🐛 44 | 🌐 Ruby | 📅 2026-09-02 - A web tool for capturing and viewing emails.
...
* [RoadRunner](https://github.com/roadrunner-server/roadrunner) ⭐ 8,506 | 🐛 46 | 🌐 Go | 📅 2026-09-09 - High-performance PHP application server, load-balancer and process manager.
